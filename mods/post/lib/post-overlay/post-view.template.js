...
module.exports = PostViewTemplate = (app, mod, sig) => {
  ...
  let post_view_actions = `
      <div class="post-view-actions">
        ${edit}
        <div data-title="${title}" data-id="${sig}" id="post-view-report-${sig}" class="post-view-report"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
