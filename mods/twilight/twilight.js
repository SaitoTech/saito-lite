...
***REMOVED***
  ...
  ***REMOVED***
      ...
      cards_img_html = cards.map(card =>  {
        return `
          <div class="cardbox-hud" id="cardbox-hud-${cards_in_pile***REMOVED***">
            ${twilight_self.returnCardImage(card)***REMOVED***
          </div>`;
  ***REMOVED***);
      ...
      //     display_message += `<div class="cardbox-hud" id="cardbox-hud-${cards_in_pile***REMOVED***">${twilight_self.returnCardImage(cards[z])***REMOVED***</div>`
      //   ***REMOVED***
      // ***REMOVED***

      let display_message = `<div class="display-cards">${cards_img_html.join('')***REMOVED***</div>`;

      if (cards_img_html.length == 0) {
        display_message = `
          <div style="text-align:center; margin: auto;">
            There are no cards in ${player_action***REMOVED***
          </div>
        `;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  handleLangMenuItem() {
    ...
    $('.card').on('click', function() {
      ...
      if (action2 === "english") {
***REMOVED*** twilight_self.displayModal("Card settings changed to English");
  ...
  ***REMOVED***
      if (action2 === "chinese") {
***REMOVED*** twilight_self.displayModal("卡牌语言改成简体中文");
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  handleLogMenuItem() {
    ...
    //
    $('.hud-menu-overlay').html(`<div style="padding: 0.5em">${$('.log').html()***REMOVED***</div>`);
...
***REMOVED***
***REMOVED*** cambridge region
***REMOVED*** chernobyl region
***REMOVED*** grainsales sender card
***REMOVED*** missileenvy sender card
***REMOVED*** latinamericandebtcrisis (if USSR can double)
***REMOVED*** che ussr country_of_target1
***REMOVED***
***REMOVED*** start round
***REMOVED*** flush [discards] // empty discards pile if exists
***REMOVED*** placement (initial placement)
***REMOVED*** ops [us/ussr] card num
***REMOVED*** round
***REMOVED*** move [us/ussr]
***REMOVED*** turn [us/ussr]
***REMOVED*** event [us/ussr] card
***REMOVED*** remove [us/ussr] [us/ussr] countryname influence     // player moving, then player whose ops to remove
***REMOVED*** place [us/ussr] [us/ussr] countryname influence      // player moving, then player whose ops to remove
***REMOVED*** resolve card
***REMOVED*** space [us/ussr] card
***REMOVED*** defcon [lower/raise]
***REMOVED*** notify [msg]
***REMOVED*** coup [us/ussr] countryname influence
***REMOVED*** realign [us/ussr] countryname
***REMOVED*** card [us/ussr] card  --> hand card to play
***REMOVED*** vp [us/ussr] points [delay_settlement_until_end_of_turn=1]
***REMOVED*** discard [us/ussr] card --> discard from hand
***REMOVED*** discard [ussr/us] card
***REMOVED*** deal [1/2]  --- player decides how many cards they need, adds DEAL and clears when ready
***REMOVED*** init
***REMOVED***
        if (mv[0] == "init") {
...
***REMOVED***
***REMOVED*** limit [restriction] [region]
***REMOVED***
        if (mv[0] == "limit") {
    ...
    ***REMOVED***
***REMOVED***
***REMOVED*** latinamericandebtcrisis
***REMOVED***
    ...
    ***REMOVED***
***REMOVED***
***REMOVED*** north sea oil bonus turn
***REMOVED***
        if (mv[0] == "northsea") {
          if (this.game.player == 1) {
    ...
    ***REMOVED***
***REMOVED***
***REMOVED*** space race  us/ussr card
***REMOVED***
        if (mv[0] == "space") {
...
***REMOVED***
  ...
  ***REMOVED***
        ...
        ***REMOVED*** else {
      ***REMOVED***this.game.deck[0].hand = ["duckandcover","degaulle","lonegunman","cubanmissile","handshake","lonegunman","asia","nasser","sadat"];
...
***REMOVED***
***REMOVED*** both players reset headline info
***REMOVED***
...
***REMOVED***
***REMOVED*** only one player should trigger next round
***REMOVED***
        if (this.game.player == 1) {
          this.addMove("resolve\theadline");
...
***REMOVED*** show headline card information to both players
        if (this.game.player == 1) {
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED*** else {
***REMOVED*** this.updateStatus("Waiting for US to move");
  ...
  ***REMOVED***
  ...
  console.log("IS_THIS_MISSILE_ENVY_NONEVENTABLE: " + is_this_missile_envy_noneventable);
    ...
    if (selected_card == null) {
      ...
      for (i = 0; i < this.game.deck[0].hand.length; i++) {
***REMOVED***
***REMOVED*** when UN Intervention is eventing, we can only select opponent cards
***REMOVED***
...
***REMOVED***
***REMOVED*** do we have any cards to play?
***REMOVED***
...
***REMOVED***
***REMOVED*** scoring cards score, not get discarded
***REMOVED***
...
***REMOVED*** true means we want to include the back button in our functionality
...
***REMOVED***
***REMOVED*** is space race an option
***REMOVED***
        let sre = 1;
...
***REMOVED***
***REMOVED*** cannot play China card or Missile Envy (forced) for event
***REMOVED***
***REMOVED*** cannot event UN Intervention w/o the opponent card in hand
***REMOVED***
...
***REMOVED***
***REMOVED*** cannot play event of opponent card (usability fix)
***REMOVED***
...
***REMOVED***
***REMOVED*** cancel cuban missile crisis
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  prePlayerPlaceInfluence(player) {
    ...
    // reset
    //
    for (var i in this.pountries) { this.game.countries[i].place = 0; ***REMOVED***
...
***REMOVED***
***REMOVED*** sanity Cuban Missile Crisis check
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  undoMove(move_type, num_of_moves) {
    ...
    switch(move_type) {
      case 'place':
***REMOVED*** iterate through the queue and remove past moves
***REMOVED*** cycle through past moves to know what to revert
...
***REMOVED*** use this to clear the "resolve ops" move
        this.removeMove();
        return 1;
      default:
        break;
...
***REMOVED***
***REMOVED*** optional latewar cards
***REMOVED***
...
***REMOVED***
***REMOVED*** let player pick another turn
***REMOVED***
...
***REMOVED***
***REMOVED*** us gets china card face up
***REMOVED***
        this.game.state.events.china_card = 0;
...
***REMOVED***
***REMOVED*** neighbouring countries
***REMOVED***
...
***REMOVED*** pseudo function to calculate control
...
***REMOVED***
  ...
  console.log("LOWERING DEFCON: " + this.game.state.defcon + " -- " + this.game.state.headline + " -- " + this.game.state.player_to_go);
    ...
    if (this.game.state.defcon == 1) {
      if (this.game.state.headline == 1) {
***REMOVED***
***REMOVED*** phasing player in headline loses
***REMOVED***
        if (this.game.state.player_to_go == 1) {
