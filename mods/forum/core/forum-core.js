    ...
    if (conf == 0) {
      ...
      switch (tx.transaction.msg.type) {
        case 'post':
          ...
          break;
        case 'comment':
          let { post_id, parent_id, post_author ***REMOVED*** = tx.transaction.msg;
