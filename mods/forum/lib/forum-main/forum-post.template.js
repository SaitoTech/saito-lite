module.exports = ForumPostTemplate = (app, data, tx) => {
      ...
      <div class="post" id="${tx.transaction.sig}" >
        <div class="post-head">
          ...
          <div class="teaser-content">
            <div class="teaser-content-title"><a href="${link}">${tx.msg.title}</a></div>
  `;
   if (domain != "") {
   ...
   html += `
      ...
      <div class="post-content">${tx.msg.content}</div>
  ...
  <div id="post-add-comment-textarea" class="post-add-comment-textarea markdown" placeholder="Your post..."></div>
	...
	<input type="hidden" class="post-forum" id="post-forum" value="${tx.msg.forum}" />
