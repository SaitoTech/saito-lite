  ...
  ***REMOVED***
  ...
  handleCardsMenuItem() {
    ...
    for (let i = 0; i <= this.game.opponents.length; i++) {
      html += `<li class="card" id="${i***REMOVED***">${this.game.players[i].role***REMOVED*** (${(i+1)***REMOVED*** - ${this.game.cities[this.game.players[i].city].name***REMOVED***)</li>`;
***REMOVED***
    html += `</ul></div>`
...
***REMOVED***
    if (this.game.cities == undefined) {
      ...
      //
      let cards_to_deal = 2;
      if (this.game.opponents.length+1 == 3) { cards_to_deal = 3; ***REMOVED***
      if (this.game.opponents.length+1 == 2) { cards_to_deal = 4; ***REMOVED***
...
***REMOVED***);
  ...
  ***REMOVED***
  ...
  playerMakeMove(moves=0) {
    ...
    if (moves == 0) { this.endTurn(); return; ***REMOVED***
...
***REMOVED***
    ...
    if (has_city_card == 0) { return 0; ***REMOVED***
    ...
    players_in_city = 0;
    for (let i = 0; i < this.game.players.length; i++) {
      if (this.game.players[i].city == city) { players_in_city++; ***REMOVED***
***REMOVED***
  
    if (players_in_city >= 2) { return 1; ***REMOVED***
...
***REMOVED***
    ...
    if (this.game.players[this.game.player-1].type == 2) { research_limit = 4; ***REMOVED***
  
    for (let i = 0; i < cards.length; i++) {
      if (this.game.deck[0].cards[cards[i]] != undefined) {
        if (this.game.deck[0].cards[cards[i]].virus == "yellow") { yellow++; ***REMOVED***
        if (this.game.deck[0].cards[cards[i]].virus == "red") { red++; ***REMOVED***
        if (this.game.deck[0].cards[cards[i]].virus == "black") { black++; ***REMOVED***
        if (this.game.deck[0].cards[cards[i]].virus == "blue") { blue++; ***REMOVED***
  ***REMOVED***
***REMOVED***
  
    if (yellow >= research_limit && this.game.state.yellow_cure == 0) { return 1; ***REMOVED***
    if (blue >= research_limit && this.game.state.blue_cure == 0) { return 1; ***REMOVED***
    if (black >= research_limit && this.game.state.black_cure == 0) { return 1; ***REMOVED***
    if (red >= research_limit && this.game.state.red_cure == 0) { return 1; ***REMOVED***
...
***REMOVED***
    ...
    if (yellow >= research_limit && this.game.state.yellow_cure == 0) { html += '<li id="yellow" class="card">yellow</li>'; ***REMOVED***
    if (blue >= research_limit && this.game.state.blue_cure == 0) { html += '<li id="blue" class="card">blue</li>'; ***REMOVED***
    if (black >= research_limit && this.game.state.black_cure == 0) { html += '<li id="black" class="card">black</li>'; ***REMOVED***
    if (red >= research_limit && this.game.state.red_cure == 0) { html += '<li id="red" class="card">red</li>'; ***REMOVED***
    html += '</ul>';
    ...
    $('.card').on('click', function() {
      ...
      if (pandemic_self.game.players[pandemic_self.game.player-1].type == 2) { research_limit = 4; ***REMOVED***
  ...
  ***REMOVED***
      ...
      if (c == "yellow") { pandemic_self.game.state.yellow_cure = 1; ***REMOVED***
      if (c == "red") { pandemic_self.game.state.red_cure = 1; ***REMOVED***
      if (c == "blue") { pandemic_self.game.state.blue_cure = 1; ***REMOVED***
      if (c == "black") { pandemic_self.game.state.black_cure = 1; ***REMOVED***
...
***REMOVED***);
  ...
  ***REMOVED***
  isCityInfected(city) {
    ...
    if (this.game.cities[city].virus.blue > 0) { return 1; ***REMOVED***
    if (this.game.cities[city].virus.black > 0) { return 1; ***REMOVED***
    if (this.game.cities[city].virus.red > 0) { return 1; ***REMOVED***
    if (this.game.cities[city].virus.yellow > 0) { return 1; ***REMOVED***
  ...
  ***REMOVED***
  canPlayerBuildResearchStation(city) {
    ...
    if (this.game.players[this.game.player-1].type == 4) {
      let city = this.game.players[this.game.player-1].city;
      if (!this.game.state.research_stations.includes(city)) {
***REMOVED***if (this.game.players[this.game.player-1].cards.length > 0) {
  	return 1;
***REMOVED******REMOVED***
  ***REMOVED***
***REMOVED***
    ...
    for (let i = 0; i < this.game.players[this.game.player-1].cards.length; i++) {
      if (this.game.players[this.game.player-1].cards[i] == city) { return 1; ***REMOVED*** 
***REMOVED***
...
***REMOVED***
    ...
    $('.city').on('click', function() {
      ...
      if (hops > pandemic_self.active_moves) { alert("Invalid Move -- too many hops"); ***REMOVED***
      else {
...
***REMOVED***);
  ...
  ***REMOVED***
  ...
  cureDisease() { // 0 = me
    ...
    if (this.game.cities[city].virus.blue > 0)   { number_of_diseases++; ***REMOVED***
    if (this.game.cities[city].virus.black > 0)  { number_of_diseases++; ***REMOVED***
    if (this.game.cities[city].virus.red > 0)    { number_of_diseases++; ***REMOVED***
    if (this.game.cities[city].virus.yellow > 0) { number_of_diseases++; ***REMOVED***
    ...
    if (number_of_diseases == 1) {
      ...
      let c = "blue";
      let cubes_to_cure = 1;
      if (pandemic_self.game.players[pandemic_self.game.player-1].type == 3) { cubes_to_cure = 3; ***REMOVED***
      
      let city = pandemic_self.game.players[pandemic_self.game.player-1].city;
  
      if ( pandemic_self.game.cities[city].virus.blue > 0 ) { 
        if (pandemic_self.game.state.blue_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.blue; ***REMOVED***
        pandemic_self.game.cities[city].virus.blue -= cubes_to_cure; pandemic_self.game.state.blue_active -= cubes_to_cure; c = "blue"; ***REMOVED***
      if ( pandemic_self.game.cities[city].virus.red > 0 )  { 
        if (pandemic_self.game.state.red_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.red; ***REMOVED***
        pandemic_self.game.cities[city].virus.red -= cubes_to_cure; pandemic_self.game.state.red_active -= cubes_to_cure; c = "red"; ***REMOVED***
      if ( pandemic_self.game.cities[city].virus.black > 0 ) { 
        if (pandemic_self.game.state.black_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.black; ***REMOVED***
        pandemic_self.game.cities[city].virus.black -= cubes_to_cure; pandemic_self.game.state.black_active -= cubes_to_cure; c = "black"; ***REMOVED***
      if ( pandemic_self.game.cities[city].virus.yellow > 0 ) { 
        if (pandemic_self.game.state.yellow_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.yellow; ***REMOVED***
        pandemic_self.game.cities[city].virus.yellow -= cubes_to_cure; pandemic_self.game.state.yellow_active -= cubes_to_cure; c = "yellow"; ***REMOVED***
...
***REMOVED***
    ...
    if (this.game.cities[city].virus.blue > 0)     { html += '<li class="card" id="blue">blue</li>'; ***REMOVED***
    if (this.game.cities[city].virus.red > 0)      { html += '<li class="card" id="red">red</li>'; ***REMOVED***
    if (this.game.cities[city].virus.black > 0)    { html += '<li class="card" id="black">black</li>'; ***REMOVED***
    if (this.game.cities[city].virus.yellow > 0)   { html += '<li class="card" id="yellow">yellow</li>'; ***REMOVED***
  ...
  ***REMOVED***
      ...
      if (c == "blue")   { 
        if (pandemic_self.game.state.blue_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.blue; ***REMOVED***
  pandemic_self.game.cities[city].virus.blue -= cubes_to_cure; ***REMOVED***
      if (c == "red")    { 
  pandemic_self.game.cities[city].virus.red -= cubes_to_cure ***REMOVED***
        if (pandemic_self.game.state.red_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.red; ***REMOVED***
      if (c == "black")  { 
        if (pandemic_self.game.state.black_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.black; ***REMOVED***
  pandemic_self.game.cities[city].virus.black -= cubes_to_cure; ***REMOVED***
      if (c == "yellow") { 
        if (pandemic_self.game.state.yellow_cure == 1) { cubes_to_cute = pandemic_self.game.cities[city].virus.yellow; ***REMOVED***
  pandemic_self.game.cities[city].virus.yellow -= cubes_to_cure; ***REMOVED***
  
      if ( pandemic_self.game.cities[city].virus.blue < 0 ) { pandemic_self.game.cities[city].virus.blue = 0; ***REMOVED***
      if ( pandemic_self.game.cities[city].virus.yellow < 0 ) { pandemic_self.game.cities[city].virus.yellow = 0; ***REMOVED***
      if ( pandemic_self.game.cities[city].virus.red < 0 ) { pandemic_self.game.cities[city].virus.red = 0; ***REMOVED***
      if ( pandemic_self.game.cities[city].virus.black < 0 ) { pandemic_self.game.cities[city].virus.black = 0; ***REMOVED***
...
***REMOVED***let html  = "Discard any card to build a research station: <ul>";
***REMOVED***for (let i = 0; i < player.cards.length; i++) {
***REMOVED***  html += '<li class="card" id="'+player.cards[i]+'">'+this.game.cities[player.cards[i]].name+'</li>';
***REMOVED******REMOVED***
***REMOVED***html += '<li class="card" id="stop">cancel</li>';
***REMOVED***html += '</ul>';
***REMOVED***
***REMOVED***this.updateStatus(html);
***REMOVED***
***REMOVED***$('.card').off();
***REMOVED***$('.card').on('click', function() {
***REMOVED***
***REMOVED***  let c = $(this).attr('id');
***REMOVED***
***REMOVED***  if (c == "stop") {
***REMOVED***    pandemic_self.playerMakeMove(pandemic_self.active_moves);
***REMOVED***    return;
***REMOVED***  ***REMOVED***
***REMOVED***
***REMOVED***  for (let i = 0; i < player.cards.length; i++) {
***REMOVED***    if (player.cards[i] == c) {
***REMOVED***      pandemic_self.addMove("discard\t"+pandemic_self.game.player+"\t"+c);
***REMOVED***      player.cards.splice(i,1);
***REMOVED***    i = player.cards.length+2;
***REMOVED******REMOVED***
***REMOVED***  ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      if (mv[0] === "resolve") {
        if (this.game.queue.length <= 1) { this.game.queue = []; ***REMOVED***
...
***REMOVED***
***REMOVED*** shuffle cards into TOP of infection deck
***REMOVED***
        let new_deck = [];
  ...
  ***REMOVED***
      if (mv[0] === "infect") {
        ...
        if (this.game.state.infection_rate > 2) { infection_cards = 3; ***REMOVED***
        if (this.game.state.infection_rate > 4) { infection_cards = 4; ***REMOVED***
  	  ...
  	  if (virus == "blue" && this.game.state.blue_cure == 1) {
  	    let total = 0;
  	    for (let key in this.game.cities) { total += this.game.cities[key].virus.blue; ***REMOVED***
  	    if (total == 0) { place_virus = 0; ***REMOVED***
  	  ***REMOVED***
  
  	  if (virus == "black" && this.game.state.black_cure == 1) {
  	    let total = 0;
  	    for (let key in this.game.cities) { total += this.game.cities[key].virus.black; ***REMOVED***
  	    if (total == 0) { place_virus = 0; ***REMOVED***
  	  ***REMOVED***
  
  	  if (virus == "red" && this.game.state.red_cure == 1) {
  	    let total = 0;
  	    for (let key in this.game.cities) { total += this.game.cities[key].virus.red; ***REMOVED***
  	    if (total == 0) { place_virus = 0; ***REMOVED***
  	  ***REMOVED***
  
  	  if (virus == "yellow" && this.game.state.yellow_cure == 1) {
  	    let total = 0;
  	    for (let key in this.game.cities) { total += this.game.cities[key].virus.yellow; ***REMOVED***
  	    if (total == 0) { place_virus = 0; ***REMOVED***
  	  ***REMOVED***
...
***REMOVED***
        for (let i = 3; i > 0; i--) {
          for (let k = 0; k < 3; k++) {
            ...
            if (virus == "yellow") { this.game.cities[newcard].virus.yellow = i; ***REMOVED***
            if (virus == "blue") { this.game.cities[newcard].virus.blue = i; ***REMOVED***
            if (virus == "black") { this.game.cities[newcard].virus.black = i; ***REMOVED***
            if (virus == "red") { this.game.cities[newcard].virus.red = i; ***REMOVED***
...
***REMOVED***
***REMOVED*** adjustable difficulty
***REMOVED***
        if (this.game.options.difficulty != undefined) {
          if (this.game.options.difficulty === "medium") { epidemics = 5; ***REMOVED***
          if (this.game.options.difficulty === "hard") { epidemics = 6; ***REMOVED***
    ***REMOVED***
  
  
***REMOVED***
***REMOVED*** add epidemic cards to deck
***REMOVED***
        this.game.deck[1].cards['epidemic1'] = { img : "Epidemic.jpg" ***REMOVED***
        this.game.deck[1].cards['epidemic2'] = { img : "Epidemic.jpg" ***REMOVED***
        this.game.deck[1].cards['epidemic3'] = { img : "Epidemic.jpg" ***REMOVED***
        this.game.deck[1].cards['epidemic4'] = { img : "Epidemic.jpg" ***REMOVED***
        this.game.deck[1].cards['epidemic5'] = { img : "Epidemic.jpg" ***REMOVED***
        this.game.deck[1].cards['epidemic6'] = { img : "Epidemic.jpg" ***REMOVED***
  
***REMOVED***
***REMOVED*** shuffle them into the undrawn pile
***REMOVED***
...
***REMOVED***
***REMOVED*** add events to deck
***REMOVED***
        let total_events = 0;
        for (var i in this.game.events) { total_events++; this.game.deck[1].cards[i] = this.game.events[i]; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      if (mv[0] === "curevirus") {
        ...
        if (this.game.player != player) {
          ...
          if (virus == "yellow") { pandemic_self.game.state.yellow_cure = 1; ***REMOVED***
          if (virus == "red")    { pandemic_self.game.state.red_cure = 1; ***REMOVED***
          if (virus == "blue")   { pandemic_self.game.state.blue_cure = 1; ***REMOVED***
          if (virus == "black")  { pandemic_self.game.state.black_cure = 1; ***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED*** if (recipient == this.game.player && recipient != sender) {
  ...
  ***REMOVED***
      if (mv[0] === "cure") {
        if (this.game.player !== parseInt(mv[1])) {
          ...
          if (pandemic_self.game.state.blue_cure == 1 && mv[4] == "blue") { mv[3] = pandemic_self.game.cities[mv[2]].virus.blue; ***REMOVED***
          if (pandemic_self.game.state.red_cure == 1 && mv[4] == "red") { mv[3] = pandemic_self.game.cities[mv[2]].virus.red; ***REMOVED***
          if (pandemic_self.game.state.yellow_cure == 1 && mv[4] == "yellow") { mv[3] = pandemic_self.game.cities[mv[2]].virus.yellow; ***REMOVED***
          if (pandemic_self.game.state.black_cure == 1 && mv[4] == "black") { mv[3] = pandemic_self.game.cities[mv[2]].virus.black; ***REMOVED***
  
  	if (mv[4] === "yellow") { pandemic_self.game.cities[mv[2]].virus.yellow -= parseInt(mv[3]); pandemic_self.game.state.yellow_active -= parseInt(mv[3]); ***REMOVED***
  	if (mv[4] === "blue") { pandemic_self.game.cities[mv[2]].virus.blue -= parseInt(mv[3]); pandemic_self.game.state.blue_active -= parseInt(mv[3]); ***REMOVED***
  	if (mv[4] === "black") { pandemic_self.game.cities[mv[2]].virus.black -= parseInt(mv[3]); pandemic_self.game.state.black_active -= parseInt(mv[3]); ***REMOVED***
  	if (mv[4] === "red") { pandemic_self.game.cities[mv[2]].virus.red -= parseInt(mv[3]); pandemic_self.game.state.red_active -= parseInt(mv[3]); ***REMOVED***
  
  	if ( pandemic_self.game.cities[mv[2]].virus.yellow < 0 ) { pandemic_self.game.cities[mv[2]].virus.yellow = 0; ***REMOVED***
  	if ( pandemic_self.game.cities[mv[2]].virus.red < 0 ) { pandemic_self.game.cities[mv[2]].virus.red = 0; ***REMOVED***
  	if ( pandemic_self.game.cities[mv[2]].virus.blue < 0 ) { pandemic_self.game.cities[mv[2]].virus.blue = 0; ***REMOVED***
  	if ( pandemic_self.game.cities[mv[2]].virus.black < 0 ) { pandemic_self.game.cities[mv[2]].virus.black = 0; ***REMOVED***
  ...
  ***REMOVED***
  ...
  addDiseaseCube(city, virus) {
    ...
    if (virus == "blue") { 
      ...
      if (this.game.state.blue_active > 24) { this.endGame("Blue Disease Outbreak Beyond Control"); return; ***REMOVED***
...
***REMOVED***
    ...
    if (virus == "black") { 
      ...
      if (this.game.state.black_active > 24) { this.endGame("Black Disease Outbreak Beyond Control"); return; ***REMOVED***
...
***REMOVED***
    if (virus == "red") { 
      ...
      if (this.game.state.red_active > 24) { this.endGame("Red Disease Outbreak Beyond Control"); return; ***REMOVED***
...
***REMOVED***
    if (virus == "yellow") { 
      ...
      if (this.game.state.yellow_active > 24) { this.endGame("Yellow Disease Outbreak Beyond Control"); return; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  returnCities() {
    ...
    cities['sanfrancisco'] = { top : 560, left : 95 , neighbours : [ 'tokyo', 'manila', 'losangeles', 'chicago' ] , name : "San Francisco" ***REMOVED***;
    cities['chicago'] = { top : 490, left : 340 , neighbours : [ 'sanfrancisco', 'losangeles', 'mexicocity', 'atlanta', 'montreal' ] , name : "Chicago" ***REMOVED***;
    cities['montreal'] = { top : 480, left : 530 , neighbours : [ 'chicago', 'newyork', 'washington' ] , name : "Montreal" ***REMOVED***;
    cities['newyork'] = { top : 505, left : 675 , neighbours : [ 'montreal', 'washington', 'london', 'madrid' ] , name : "New York" ***REMOVED***;
    cities['washington'] = { top : 625, left : 615 , neighbours : [ 'montreal', 'newyork', 'miami', 'atlanta' ] , name : "Washington" ***REMOVED***;
    cities['atlanta'] = { top : 630, left : 410 , neighbours : [ 'chicago', 'miami', 'washington' ] , name : "Atlanta" ***REMOVED***;
    cities['losangeles'] = { top : 750, left : 135 , neighbours : [ 'sydney', 'sanfrancisco', 'mexicocity', 'chicago' ] , name : "Los Angeles" ***REMOVED***;
    cities['mexicocity'] = { top : 815, left : 315 , neighbours : [ 'chicago', 'losangeles', 'miami', 'bogota', 'lima' ] , name : "Mexico City" ***REMOVED***;
    cities['miami'] = { top : 790, left : 530 , neighbours : [ 'washington', 'atlanta', 'mexicocity', 'bogota' ] , name : "Miami" ***REMOVED***;
    cities['bogota'] = { top : 980, left : 515 , neighbours : [ 'miami', 'mexicocity', 'lima', 'saopaulo', 'buenosaires' ] , name : "Bogota" ***REMOVED***;
    cities['lima'] = { top : 1180, left : 445 , neighbours : [ 'santiago', 'bogota', 'mexicocity' ] , name : "Lima" ***REMOVED***;
    cities['santiago'] = { top : 1390, left : 470 , neighbours : [ 'lima' ] , name : "Santiago" ***REMOVED***;
    cities['buenosaires'] = { top : 1355, left : 670 , neighbours : [ 'saopaulo', 'bogota' ] , name : "Buenos Aires" ***REMOVED***;
    cities['saopaulo'] = { top : 1210, left : 780 , neighbours : [ 'bogota', 'buenosaires', 'madrid', 'lagos' ] , name : "Sao Paulo" ***REMOVED***;
    cities['lagos'] = { top : 950, left : 1150 , neighbours : [ 'saopaulo', 'khartoum', 'kinshasa' ] , name : "Lagos" ***REMOVED***;
    cities['khartoum'] = { top : 910, left : 1395 , neighbours : [ 'cairo', 'lagos', 'kinshasa', 'johannesburg' ] , name : "Khartoum" ***REMOVED***;
    cities['kinshasa'] = { top : 1080, left : 1275 , neighbours : [ 'lagos', 'khartoum', 'johannesburg' ] , name : "Kinshasa" ***REMOVED***;
    cities['johannesburg'] = { top : 1270, left : 1385 , neighbours : [ 'kinshasa', 'khartoum' ] , name : "Johannesburg" ***REMOVED***;
    cities['london'] = { top : 390, left : 1025 , neighbours : [ 'newyork', 'madrid', 'essen', 'paris' ] , name : "London" ***REMOVED***;
    cities['madrid'] = { top : 580, left : 1005 , neighbours : [ 'newyork', 'paris', 'london' , 'algiers' , 'saopaulo' ] , name : "Madrid" ***REMOVED***;
    cities['essen'] = { top : 360, left : 1220 , neighbours : [ 'stpetersburg', 'london', 'milan' ] , name : "Essen" ***REMOVED***;
    cities['paris'] = { top : 485, left : 1170 , neighbours : [ 'london', 'essen', 'madrid', 'milan', 'algiers' ] , name : "Paris" ***REMOVED***;
    cities['stpetersburg'] = { top : 320, left : 1430 , neighbours : [ 'essen', 'moscow' , 'istanbul' ] , name : "St. Petersburg" ***REMOVED***;
    cities['milan'] = { top : 450, left : 1300 , neighbours : [ 'essen', 'istanbul', 'paris' ] , name : "Milan" ***REMOVED***;
    cities['algiers'] = { top : 685, left : 1220 , neighbours : [ 'madrid', 'paris', 'cairo', 'istanbul' ] , name : "Algiers" ***REMOVED***;
    cities['cairo'] = { top : 720, left : 1360 , neighbours : [ 'khartoum', 'algiers', 'istanbul', 'baghdad', 'riyadh' ] , name : "Cairo" ***REMOVED***;
    cities['istanbul'] = { top : 560, left : 1385 , neighbours : [ 'stpetersburg', 'milan', 'algiers', 'cairo', 'baghdad', 'moscow' ] , name : "Istanbul" ***REMOVED***;
    cities['moscow'] = { top : 450, left : 1535 , neighbours : [ 'stpetersburg', 'tehran', 'istanbul' ] , name : "Moscow" ***REMOVED***;
    cities['baghdad'] = { top : 660, left : 1525 , neighbours : [ 'cairo', 'riyadh', 'karachi', 'tehran', 'istanbul' ] , name : "Baghdad" ***REMOVED***;
    cities['riyadh'] = { top : 830, left : 1545 , neighbours : [ 'cairo', 'istanbul', 'karachi' ] , name : "Riyadh" ***REMOVED***;
    cities['tehran'] = { top : 540, left : 1665 , neighbours : [ 'moscow', 'karachi', 'baghdad', 'delhi' ] , name : "Tehran" ***REMOVED***;
    cities['karachi'] = { top : 720, left : 1705 , neighbours : [ 'baghdad', 'tehran', 'delhi', 'riyadh', 'mumbai' ] , name : "Karachi" ***REMOVED***;
    cities['mumbai'] = { top : 865, left : 1720 , neighbours : [ 'chennai', 'karachi', 'delhi' ] , name : "Mumbai" ***REMOVED***;
    cities['delhi'] = { top : 670, left : 1845 , neighbours : [ 'tehran', 'karachi', 'mumbai', 'chennai' , 'kolkata' ] , name : "Delhi" ***REMOVED***;
    cities['chennai'] = { top : 965, left : 1870 , neighbours : [ 'mumbai', 'delhi', 'kolkata', 'bangkok', 'jakarta' ] , name : "Chennai" ***REMOVED***;
    cities['kolkata'] = { top : 715, left : 1975 , neighbours : [ 'delhi', 'chennai', 'bangkok', 'hongkong' ] , name : "Kolkata" ***REMOVED***;
    cities['bangkok'] = { top : 880, left : 2005 , neighbours : [ 'kolkata', 'hongkong', 'chennai', 'jakarta', 'hochiminhcity' ] , name : "Bangkok" ***REMOVED***;
    cities['jakarta'] = { top : 1130, left : 2005 , neighbours : [ 'chennai', 'bangkok', 'hochiminhcity', 'sydney' ] , name : "Jakarta" ***REMOVED***;
    cities['sydney'] = { top : 1390, left : 2420 , neighbours : [ 'jakarta', 'manila', 'losangeles' ] , name : "Sydney" ***REMOVED***;
    cities['manila'] = { top : 1000, left : 2305 , neighbours : [ 'sydney', 'hongkong', 'hochiminhcity', 'sanfrancisco', 'taipei' ] , name : "Manila" ***REMOVED***;
    cities['hochiminhcity'] = { top : 1010, left : 2120 , neighbours : [ 'jakarta', 'bangkok', 'hongkong', 'manila' ] , name : "Ho Chi Minh City" ***REMOVED***;
    cities['hongkong'] = { top : 790, left : 2115 , neighbours : [ 'hochiminhcity', 'shanghai', 'bangkok', 'kolkata', 'taipei' , 'manila' ] , name : "Hong Kong" ***REMOVED***;
    cities['taipei'] = { top : 765, left : 2270 , neighbours : [ 'shanghai', 'hongkong', 'manila', 'osaka' ] , name : "Taipei" ***REMOVED***;
    cities['shanghai'] = { top : 630, left : 2095 , neighbours : [ 'beijing', 'hongkong', 'taipei', 'seoul', 'tokyo' ] , name : "Shanghai" ***REMOVED***;
    cities['beijing'] = { top : 500, left : 2085 , neighbours : [ 'shanghai', 'seoul' ] , name : "Beijing" ***REMOVED***;
    cities['seoul'] = { top : 485, left : 2255 , neighbours : [ 'beijing', 'shanghai', 'tokyo' ] , name : "Seoul" ***REMOVED***;
    cities['tokyo'] = { top : 565, left : 2385 , neighbours : [ 'seoul', 'shanghai', 'sanfrancisco', 'osaka' ] , name : "Tokyo" ***REMOVED***;
    cities['osaka'] = { top : 710, left : 2405 , neighbours : [ 'taipei', 'tokyo' ] , name : "Osaka" ***REMOVED***;
  
    //
    // set initial viral load
    //
    for (var key in cities) {
      cities[key].virus = {***REMOVED***;
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  returnEvents() {
    ...
    events['event1'] = { img : 'Special%20Event%20-%20Airlift.jpg' , name : 'Airlift' , virus : "" ***REMOVED***
    events['event2'] = { img : 'Special%20Event%20-%20Resilient%20Population.jpg' , name : 'Resilient Population' , virus : "" ***REMOVED***
    events['event3'] = { img : 'Special%20Event%20-%20One%20Quiet%20Night.jpg' , name : 'One Quiet Night' , virus : "" ***REMOVED***
    events['event4'] = { img : 'Special%20Event%20-%20Forecast.jpg' , name : 'Forecast' , virus : "" ***REMOVED***
    events['event5'] = { img : 'Special%20Event%20-%20Government%20Grant.jpg' , name : 'Government Grant' , virus : "" ***REMOVED***
  ...
  ***REMOVED***
  ...
  returnInfectionCards() {
    ...
    deck['sanfrancisco'] = { img : "Infection%20Blue%20San%20Francisco.jpg" , virus : "blue" ***REMOVED***
    deck['chicago'] =  { img : "Infection%20Blue%20Chicago.jpg" , virus : "blue" ***REMOVED***
    deck['montreal'] =  { img : "Infection%20Blue%20Toronto.jpg" , virus : "blue" ***REMOVED***;
    deck['newyork'] =  { img : "Infection%20Blue%20New%20York.jpg" , virus : "blue" ***REMOVED***;
    deck['washington'] =  { img : "Infection%20Blue%20Washington.jpg" , virus : "blue" ***REMOVED***;
    deck['atlanta'] =  { img : "Infection%20Blue%20Atlanta.jpg" , virus : "blue" ***REMOVED***;
    deck['losangeles'] =  { img : "Infection%20Yellow%20Los%20Angeles.jpg" , virus : "yellow" ***REMOVED***;
    deck['mexicocity'] =  { img : "Infection%20Yellow%20Mexico%20City.jpg" , virus : "yellow" ***REMOVED***;
    deck['miami'] =  { img : "Infection%20Yellow%20Miami.jpg" , virus : "yellow" ***REMOVED***;
    deck['bogota'] =  { img : "Infection%20Yellow%20Bogota.jpg" , virus : "yellow" ***REMOVED***;
    deck['lima'] =  { img : "Infection%20Yellow%20Lima.jpg" , virus : "yellow" ***REMOVED***;
    deck['santiago'] =  { img : "Infection%20Yellow%20Santiago.jpg" , virus : "yellow" ***REMOVED***;
    deck['buenosaires'] =  { img : "Infection%20Yellow%20Buenos%20Aires.jpg" , virus : "yellow" ***REMOVED***;
    deck['saopaulo'] =  { img : "Infection%20Yellow%20Sao%20Paulo.jpg" , virus : "yellow" ***REMOVED***;
    deck['lagos'] =  { img : "Infection%20Yellow%20Lagos.jpg" , virus : "yellow" ***REMOVED***;
    deck['khartoum'] =  { img : "Infection%20Yellow%20Khartoum.jpg" , virus : "yellow" ***REMOVED***;
    deck['kinshasa'] =  { img : "Infection%20Yellow%20Kinsasha.jpg" , virus : "yellow" ***REMOVED***;
    deck['johannesburg'] =  { img : "Infection%20Yellow%20Johannesburg.jpg" , virus : "yellow" ***REMOVED***;
    deck['london'] =  { img : "Infection%20Blue%20London.jpg" , virus : "blue" ***REMOVED***;
    deck['madrid'] =  { img : "Infection%20Blue%20Madrid.jpg" , virus : "blue" ***REMOVED***;
    deck['essen'] =  { img : "Infection%20Blue%20Essen.jpg" , virus : "blue" ***REMOVED***;
    deck['paris'] =  { img : "Infection%20Blue%20Paris.jpg" , virus : "blue" ***REMOVED***;
    deck['stpetersburg'] =  { img : "Infection%20Blue%20St.%20Petersburg.jpg" , virus : "blue" ***REMOVED***;
    deck['milan'] =  { img : "Infection%20Blue%20Milan.jpg" , virus : "blue" ***REMOVED***;
    deck['algiers'] =  { img : "Infection%20Black%20Algiers.jpg" , virus : "black" ***REMOVED***;
    deck['cairo'] =  { img : "Infection%20Black%20Cairo.jpg" , virus : "black" ***REMOVED***;
    deck['istanbul'] =  { img : "Infection%20Black%20Istanbul.jpg" , virus : "black" ***REMOVED***;
    deck['moscow'] =  { img : "Infection%20Black%20Moscow.jpg" , virus : "black" ***REMOVED***;
    deck['baghdad'] =  { img : "Infection%20Black%20Baghdad.jpg" , virus : "black" ***REMOVED***;
    deck['riyadh'] =  { img : "Infection%20Black%20Riyadh.jpg" , virus : "black" ***REMOVED***;
    deck['tehran'] =  { img : "Infection%20Black%20Tehran.jpg" , virus : "black" ***REMOVED***;
    deck['karachi'] =  { img : "Infection%20Black%20Karachi.jpg" , virus : "black" ***REMOVED***;
    deck['mumbai'] =  { img : "Infection%20Black%20Mumbai.jpg" , virus : "black" ***REMOVED***;
    deck['delhi'] =  { img : "Infection%20Black%20Delhi.jpg" , virus : "black" ***REMOVED***;
    deck['chennai'] =  { img : "Infection%20Black%20Chennai.jpg" , virus : "black" ***REMOVED***;
    deck['kolkata'] =  { img : "Infection%20Black%20Kolkata.jpg" , virus : "black" ***REMOVED***;
    deck['bangkok'] =  { img : "Infection%20Red%20Bangkok.jpg" , virus : "red" ***REMOVED***;
    deck['jakarta'] =  { img : "Infection%20Red%20Jakarta.jpg" , virus : "red" ***REMOVED***;
    deck['sydney'] =  { img : "Infection%20Red%20Sydney.jpg" , virus : "red" ***REMOVED***;
    deck['manila'] =  { img : "Infection%20Red%20Manila.jpg" , virus : "red" ***REMOVED***;
    deck['hochiminhcity'] =  { img : "Infection%20Red%20Ho%20Chi%20Minh%20City.jpg" , virus : "red" ***REMOVED***;
    deck['hongkong'] =  { img : "Infection%20Red%20Hong%20Kong.jpg" , virus : "red" ***REMOVED***;
    deck['taipei'] =  { img : "Infection%20Red%20Taipei.jpg" , virus : "red" ***REMOVED***;
    deck['shanghai'] =  { img : "Infection%20Red%20Shanghai.jpg" , virus : "red" ***REMOVED***;
    deck['beijing'] =  { img : "Infection%20Red%20Beijing.jpg" , virus : "red" ***REMOVED***;
    deck['seoul'] =  { img : "Infection%20Red%20Seoul.jpg" , virus : "red" ***REMOVED***;
    deck['tokyo'] =  { img : "Infection%20Red%20Tokyo.jpg" , virus : "red" ***REMOVED***;
    deck['osaka'] = { img : "Infection%20Red%20Osaka.jpg" , virus : "red" ***REMOVED***;
  ...
  ***REMOVED***
  returnRoleCards() {
    ...
    deck['osaka'] = { img : "card_osaka.jpg" ***REMOVED***;
  ...
  ***REMOVED***
  ...
  returnPlayerCards() {
    ...
    deck['sanfrancisco'] = { img : "Card%20Blue%20San%20Francisco.jpg" , name : "San Francisco" , virus : "blue" ***REMOVED***
    deck['chicago'] =  { img : "Card%20Blue%20Chicago.jpg" , name : "Chicago" , virus : "blue" ***REMOVED***
    deck['montreal'] =  { img : "Card%20Blue%20Toronto.jpg"  , name : "Montreal" , virus : "blue" ***REMOVED***;
    deck['newyork'] =  { img : "Card%20Blue%20New%20York.jpg"  , name : "New York" , virus : "blue" ***REMOVED***;
    deck['washington'] =  { img : "Card%20Blue%20Washington.jpg" , name : "Washington" , virus : "blue" ***REMOVED***;
    deck['atlanta'] =  { img : "Card%20Blue%20Atlanta.jpg" , name : "Atlanta" , virus : "blue" ***REMOVED***;
    deck['london'] =  { img : "Card%20Blue%20London.jpg" , name : "London" , virus : "blue" ***REMOVED***;
    deck['madrid'] =  { img : "Card%20Blue%20Madrid.jpg" , name : "Madrid" , virus : "blue" ***REMOVED***;
    deck['essen'] =  { img : "Card%20Blue%20Essen.jpg" , name : "Essen" , virus : "blue" ***REMOVED***;
    deck['paris'] =  { img : "Card%20Blue%20Paris.jpg" , name : "Paris" , virus : "blue" ***REMOVED***;
    deck['stpetersburg'] =  { img : "Card%20Blue%20St.%20Petersburg.jpg" , name : "St. Petersburg" , virus : "blue" ***REMOVED***;
    deck['milan'] =  { img : "Card%20Blue%20Milan.jpg" , name : "Milan" , virus : "blue" ***REMOVED***;
    deck['losangeles'] =  { img : "Card%20Yellow%20Los%20Angeles.jpg" , name : "Los Angeles" , virus : "yellow" ***REMOVED***;
    deck['mexicocity'] =  { img : "Card%20Yellow%20Mexico%20City.jpg" , name : "Mexico City" , virus : "yellow" ***REMOVED***;
    deck['miami'] =  { img : "Card%20Yellow%20Miami.jpg" , name : "Miami" , virus : "yellow" ***REMOVED***;
    deck['bogota'] =  { img : "Card%20Yellow%20Bogota.jpg" , name : "Bogota" , virus : "yellow" ***REMOVED***;
    deck['lima'] =  { img : "Card%20Yellow%20Lima.jpg" , name : "Lima" , virus : "yellow" ***REMOVED***;
    deck['santiago'] =  { img : "Card%20Yellow%20Santiago.jpg" , name : "Santiago" , virus : "yellow" ***REMOVED***;
    deck['buenosaires'] =  { img : "Card%20Yellow%20Buenos%20Aires.jpg" , name : "Buenos Aires" , virus : "yellow" ***REMOVED***;
    deck['saopaulo'] =  { img : "Card%20Yellow%20Sao%20Paulo.jpg" , name : "Sao Paulo" , virus : "yellow" ***REMOVED***;
    deck['lagos'] =  { img : "Card%20Yellow%20Lagos.jpg" , name : "Lagos" , virus : "yellow" ***REMOVED***;
    deck['khartoum'] =  { img : "Card%20Yellow%20Khartoum.jpg" , name : "Khartoum" , virus : "yellow" ***REMOVED***;
    deck['kinshasa'] =  { img : "Card%20Yellow%20Kinsasha.jpg" , name : "Kinshasa" , virus : "yellow" ***REMOVED***;
    deck['johannesburg'] =  { img : "Card%20Yellow%20Johannesburg.jpg" , name : "Johannesburg" , virus : "yellow" ***REMOVED***;
    deck['algiers'] =  { img : "Card%20Black%20Algiers.JPG" , name : "Algiers" , virus : "black" ***REMOVED***;
    deck['cairo'] =  { img : "Card%20Black%20Cairo.jpg" , name : "Cairo" , virus : "black" ***REMOVED***;
    deck['istanbul'] =  { img : "Card%20Black%20Istanbul.jpg" , name : "Istanbul" , virus : "black" ***REMOVED***;
    deck['moscow'] =  { img : "Card%20Black%20Moscow.jpg" , name : "Moscow" , virus : "black" ***REMOVED***;
    deck['baghdad'] =  { img : "Card%20Black%20Baghdad.jpg" , name : "Baghdad" , virus : "black" ***REMOVED***;
    deck['riyadh'] =  { img : "Card%20Black%20Riyadh.jpg" , name : "Riyadh" , virus : "black" ***REMOVED***;
    deck['tehran'] =  { img : "Card%20Black%20Tehran.jpg" , name : "Tehran" , virus : "black" ***REMOVED***;
    deck['karachi'] =  { img : "Card%20Black%20Karachi.jpg" , name : "Karachi" , virus : "black" ***REMOVED***;
    deck['mumbai'] =  { img : "Card%20Black%20Mumbai.jpg" , name : "Mumbai" , virus : "black" ***REMOVED***;
    deck['delhi'] =  { img : "Card%20Black%20Delhi.jpg" , name : "New Delhi" , virus : "black" ***REMOVED***;
    deck['chennai'] =  { img : "Card%20Black%20Chennai.jpg" , name : "Chennai" , virus : "black" ***REMOVED***;
    deck['kolkata'] =  { img : "Card%20Black%20Kolkata.jpg" , name : "Kolkata" , virus : "black" ***REMOVED***;
    deck['bangkok'] =  { img : "Card%20Red%20Bangkok.jpg" , name : "Bangkok" , virus : "red" ***REMOVED***;
    deck['jakarta'] =  { img : "Card%20Red%20Jakarta.jpg" , name : "Jakarta" , virus : "red" ***REMOVED***;
    deck['sydney'] =  { img : "Card%20Red%20Sydney.jpg" , name : "Sydney" , virus : "red" ***REMOVED***;
    deck['manila'] =  { img : "Card%20Red%20Manila.jpg" , name : "Manila" , virus : "red" ***REMOVED***;
    deck['hochiminhcity'] =  { img : "Card%20Red%20Ho%20Chi%20Minh%20City.jpg" , name : "Ho Chi Minh City" , virus : "red" ***REMOVED***;
    deck['hongkong'] =  { img : "Card%20Red%20Hong%20Kong.jpg" , name : "Hong Kong" , virus : "red" ***REMOVED***;
    deck['taipei'] =  { img : "Card%20Red%20Taipei.jpg" , name : "Taipei" , virus : "red" ***REMOVED***;
    deck['shanghai'] =  { img : "Card%20Red%20Shanghai.jpg" , name : "Shanghai" , virus : "red" ***REMOVED***;
    deck['beijing'] =  { img : "Card%20Red%20Beijing.jpg" , name : "Beijing" , virus : "red" ***REMOVED***;
    deck['seoul'] =  { img : "Card%20Red%20Seoul.jpg" , name : "Seoul" , virus : "red" ***REMOVED***;
    deck['tokyo'] =  { img : "Card%20Red%20Tokyo.jpg" , name : "Tokyo" , virus : "red" ***REMOVED***;
    deck['osaka'] = { img : "Card%20Red%20Osaka.jpg" , name : "Osaka" , virus : "red" ***REMOVED***;
  ...
  returnCardItem(card, cardtype="city") {
    ...
    if (this.interface == 1) {
      if (this.game.cities[card] == undefined) {
        return `<div id="${card.replace(/ /g,'')***REMOVED***" class="card cardbox-hud-image showcard cardbox-hud cardbox-hud-status">${this.returnCardImage(card, cardtype)***REMOVED***</div>`;
  ***REMOVED***
      return `<div id="${card.replace(/ /g,'')***REMOVED***" class="card cardbox-hud-image showcard cardbox-hud cardbox-hud-status">${this.returnCardImage(card, cardtype)***REMOVED***</div>`;
***REMOVED*** else {
      if (this.game.cities[card] == undefined) {
...
***REMOVED***
    ...
    html = `
      <div class="cardbox-status-container">
        ...
        ${this.returnCardList(cards, "city")***REMOVED***
      </div>
    `
...
***REMOVED***
    ...
    for (var index in options) { new_options[index] = options[index]; ***REMOVED***
