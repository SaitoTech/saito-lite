module.exports = AppStoreAppspaceTemplate = () => {
  let applist = [0,0,0,0].map((_, index) => {
    return `
      <div id="appstore-app-item-${index***REMOVED***" class="appstore-app-item">
  ...
  ***REMOVED***).join('');
  ...
  let browselist = [0,0,0,0].map((_, index) => {
    return `
      <div id="appstore-browse-item-${index***REMOVED***" class="appstore-browse-item">
...
<div class="appspace-appstore-container">
  ...
  <div class="appstore-app-list">${applist***REMOVED***</div>
  ...
  <div class="appstore-browse-list">${browselist***REMOVED***</div>
