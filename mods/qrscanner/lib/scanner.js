              ...
              devices.forEach(function(device) {
                ...
                if (device.kind === 'videoinput') {
                  if(device.label.toLowerCase().search("back") >-1)
                    options=[{'sourceId': device.deviceId***REMOVED***] ;
            ***REMOVED***
...
***REMOVED***
    ...
    if(n.getUserMedia)
        n.getUserMedia({video: options, audio: false***REMOVED***, qrcode.vidSuccess, qrcode.vidError);
    else
    if(n.webkitGetUserMedia)
    {
        qrcode.webkit=true;
        n.webkitGetUserMedia({video:options, audio: false***REMOVED***, qrcode.vidSuccess, qrcode.vidError);
***REMOVED***
    else
    if(n.mozGetUserMedia)
    {
        qrcode.moz=true;
        n.mozGetUserMedia({video: options, audio: false***REMOVED***, qrcode.vidSuccess, qrcode.vidError);
***REMOVED***
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***var canvas_qr = document.getElementById("qr-canvas");
...
{
    var regexp = /(ftp|http|https):\/\/(\w+:{0,1***REMOVED***\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;
...
***REMOVED***
    for (var ay = 0; ay < numSqrtArea; ay++)
    {
        for (var ax = 0; ax < numSqrtArea; ax++)
        {
            ...
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***minmax[ax][ay][0] = (minmax[ax][ay][0] + minmax[ax][ay][1]) / 2;
    ***REMOVED***
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***Console.out.print(middle[ax][ay] + ",");
    ***REMOVED***
***REMOVED***Console.out.println("");
***REMOVED***
    //Console.out.println("");
			...
			***REMOVED***
			...
			if (this.possibleCenters.length > 3)
			{
				...
				this.possibleCenters.sort(function(a, b){
					if (a.count > b.count){return -1;***REMOVED***
					if (a.count < b.count){return 1;***REMOVED***
					return 0;
				***REMOVED***);
			***REMOVED***
