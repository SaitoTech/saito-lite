...
***REMOVED***;
  ...
  ***REMOVED***
  ...
  async initializeHTML(app) {
    ...
    //this.decoder = new Worker('/qrscanner/quirc_worker', {type: 'module'***REMOVED***);
...
***REMOVED*** QRReader.active = false;
***REMOVED*** QRReader.last_scanned_raw = qrid;
***REMOVED*** QRReader.last_scanned_at = right_now;
      alert(qrid);
      // ***REMOVED*** else if (qrid == QRReader.last_scanned_raw) {
