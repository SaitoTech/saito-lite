const defaultDescription = "Game Available";
...
let makeDescription = (app, invite) => {
  let moduleDescriptionMaker = app.modules.returnModule(invite.msg.module).requestInterface("makeInviteDescription");
