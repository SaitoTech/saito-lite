...
module.exports = ChatMessageContainerTemplate = (message_block, data) => {
  let { identicon, messages, publickey, keyHTML, timestamp, last_message_timestamp, type } = message_block;
  ...
  return `
    <div class="chat-message-container chat-message-${type}" id="chat-message-container-${publickey}-${timestamp}">
