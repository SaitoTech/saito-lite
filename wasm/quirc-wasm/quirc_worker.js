...
//   ***REMOVED***).then(function(wasm_file) {
...
self.decoded = function(i, version, ecc_level, mask, data_type, payload, payload_len) {
  ...
  postMessage({ i: i, version: version, ecc_level: ecc_level, mask: mask, data_type: data_type, payload: payload, payload_len: payload_len, payload_string: payload_string ***REMOVED***);
***REMOVED***
