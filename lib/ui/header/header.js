...
module.exports = HomeHeader = {
    ...
    render(app) {
        ...
        //
        // which modules want to be in the header ???
        //
        let ddmods = [];
	...
	let is_email_mod_active = 0;
	  ...
	  if (app.modules.mods[i].name == "Email" && app.modules.mods[i].browser_active == 1) {
        ...
        if (document.getElementById('header-dropdown-add-friends')) {
          document.getElementById('header-dropdown-add-friends').onclick = () => {
	   	    alert("Adding Friends Clicked");
          };
        }
