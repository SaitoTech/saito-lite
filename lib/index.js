...
console.log("POST STORAGE INIT: " + JSON.stringify(this.options));

      this.wallet.initialize();
      this.mempool.initialize();
      this.keys.initialize();

console.log("POST KEYS INIT: " + JSON.stringify(this.options));
...
console.log("POST MODULES INIT: " + JSON.stringify(this.options));
