...
class ModTemplate {
  ...
  ***REMOVED***
  ...
  async installModule(app) {
    ...
    let database = encodeURI(this.returnSlug());
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  //
  async onConfirmation(blk, tx, confnum, app) {***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  returnSlug() {
    if (this.slug != "") { return this.slug; ***REMOVED***
    else {
...
***REMOVED***
  ***REMOVED***
  ...
  returnLink() {
    if (this.link != "") { return this.link; ***REMOVED***
    else {
