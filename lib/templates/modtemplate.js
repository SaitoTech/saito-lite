...
class ModTemplate {
  ...
  //
  // static onlyOnActiveBrowser(app, someMethod) {
  //   return function () {
  ...
  // //
  // static onlyInBrowser(app, someMethod) {
  //   return function () {
  //     if(app.BROWSER) {
  //       let returnVal = someMethod.apply(this, arguments);
  //       return returnVal;
  ...
  // // run in a browser environment.
  // //
  // static onlyOnServer(app, someMethod) {
  //   return function () {
  //     if(app.BROWSER) {
  //       let returnVal = someMethod.apply(this, arguments);
  //       return returnVal;
  ...
  //   };
  // }
  // static browserize(app, template) {
  //
  //   template.initialize = ModTemplate.onlyInBrowser(app, template.initialize.bind(template));
  //   template.initializeHTML = ModTemplate.onlyInBrowser(app, template.initializeHTML.bind(template));
  //   template.updateBalance = ModTemplate.onlyInBrowser(app, template.updateBalance.bind(template));
  //   template.render = ModTemplate.onlyInBrowser(app, template.render.bind(template));
  //   template.attachEvents = ModTemplate.onlyInBrowser(app, template.attachEvents.bind(template)); // deprecated
  // }
