...
console.log(this.name + " listening to " + this.events[i]);
...
console.log("CHECKING DIR: " + webdir);
...
***REMOVED***
  ...
  ***REMOVED***;
  ...
  receiveEvent(eventname, data) {
    console.log("RECEIVED EVENT: " + eventname + " - in ModTemplate: " + JSON.stringify(data));
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  async handlePeerRequest(app, message, peer, mycallback=null) {
    console.log("handle peer request in template!");
  ***REMOVED***
