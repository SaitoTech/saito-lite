...
//console.log(JSON.stringify(rows));
  ...
  sendPeerDatabaseRequestWithFilter(db="", sql="", success_callback=null, peerfilter=null) {
    ...
    this.sendPeerRequestWithFilter(function() { return msg; }, success_callback, peer_filter);
  ...
  async sendPeerRequestWithFilter(msg_callback=null, peerfilter=null, success_callback=null) {
