...
console.log("TRIGGERING CALLBACK: " + JSON.stringify(res));
	mycallback(res);

  ***REMOVED***
***REMOVED***

console.log("EXITING BACK FROM SUPER");
  ***REMOVED***
...
console.log("SENDING2: !");
  ...
  ***REMOVED***);
***REMOVED*** else {
console.log("\n\n\nSENDNG REQUEST WITH CALLBACK IN SPDR");
