  ...
  returnForm(dbname, dbtable, id, row) {
    ...
    Object.entries(row).forEach(field => {
      ...
      switch (field[0]) {
        ...
        case 'publickey':
        case 'admin':
          meta += "<div style='display:none;'><input class='input' data-dbname='" + dbname + "' data-id='" + id + "' data-table='suppliers' type='hidden' data-column='" + field[0] + "' value='" + field[1] + "' /></div>";
          break;
        default:
          body += "<div>" + field[0] + "</div>";
          body += "<div><input class='input' data-dbname='" + dbname + "' data-id='" + id + "' data-table='suppliers' type='text' data-column='" + field[0] + "' value='" + field[1] + "' /></div>";
          break;
      }
    });
    return body + meta;
