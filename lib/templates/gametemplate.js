...
console.log("SEND OFFCHAIN: " + game_self.game.initializing + " -- " + game_self.initialize_game_offchain_if_possible + " -- " + game_self.game.players.length);
...
console.log(" ... just sent");
    ...
    //
console.log("SENDING GAME MOVE onchain");
