...
console.log("these pending transactions appear to be for this game...");

              if (game_self == this) {
                if (game_self.game.step.game > txmsg.step.game) {
console.log("deleting this pending tx as game has progressed...");
...
console.log("SENDING GAME MOVE offchain");
...
console.log("SENT GAME MOVE onchain - error ? " + JSON.stringify(errobj));
    });
