...
console.log("GAME IS NOT HALTED: " + is_future_move + " -- " + is_unprocessed_move);
...
//console.log("PUSHING INTO FUTURE 3: " + JSON.stringify(txmsg.turn));
	      ...
	      for (let c = 0; c < app.wallet.wallet.pending.length; c++) {
	        ...
	        if (newtx.msg) {
		      ...
		      // avoid processFutureMoves INSIDE handleGameMove -- july 24th <-- tucho bug
                      //game_self.processFutureMoves();
...
console.log("updating "+tx.transaction.from[0].add+" to: " + txmsg.step.game);
