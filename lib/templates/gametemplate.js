...
console.log("WE HAVE FOUND THE GAME!");
...
console.log("WE HAVE THIS THIS POINT");
console.log(app.options.games[i].observer_mode_active);
...
console.log("QUEUE START: " + this.game.queue);
console.log("RUNNING QUEUE as player: " + this.game.player);
console.log("GAME STEP: " + JSON.stringify(this.game.step));
...
console.log("Game ID: " + gametxmsg.game_id);
