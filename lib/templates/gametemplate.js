...
console.log("INITIALIZE GAME FEEDER! 1");
    ...
    //
console.log("P2: " + this.game.player);
    this.loadGame(game_id);
console.log("P3: " + this.game.player);
...
console.log("P4: " + this.game.player);
    //
...
console.log("P5: " + this.game.player);
    this.runQueue();
console.log("P6: " + this.game.player);
    return 1;
...
console.log(this.game.opponents);
  ***REMOVED***
  ...
  receiveGameoverRequest(blk, tx, conf, app) {
    let txmsg = tx.returnMessage();
    let { game_id, module ***REMOVED*** = txmsg;
  ...
  ***REMOVED***
  ...
  //
  // why is there no game info in gametemplate?
  //
  resignGame(game_id) {
    ...
    if (game.over == 0) {
      let { winner, module ***REMOVED*** = game;
  ...
  ***REMOVED***
      ...
      newtx.transaction = Object.assign(newtx.transaction, { msg ***REMOVED***);
...
***REMOVED***
    ...
    //
console.log("SENDING onchain now!");
