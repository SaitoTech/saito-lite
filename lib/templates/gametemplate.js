...
try {
    ...
    this.commands.push((game_self,gmv) => {
	  ...
	  game_self.gamePay(amount, recipient, crypto, function() {
    ...
    this.commands.push((game_self,gmv) => {
	  ...
	  game_self.gameReceive(amount, recipient, sender, crypto, function() {
    ...
    this.commands.push((game_self,gmv) => {
	  ...
	  game_self.gameBalance(amount, account, crypto, function() {
  ...
  gamePay(amount, recipient, crypto, mycallback) {
    console.log("about to make a payment...");
    setTimeout(function() {
      console.log("payment made...");
      mycallback();
    }, 1000);
  }
  gameReceive(amount, recipient, sender, crypto, mycallback) {
    console.log("about to receive a payment...");
    setTimeout(function() {
      console.log("payment received...");
      mycallback();
    }, 2000);
  }
  gameBalance(amount, account, crypto, mycallback) {
