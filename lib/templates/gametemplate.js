	  ...
	  if (only_process_next_move == 1) {
	    ...
	    if (game_self.isFutureMove(tx.transaction.from[0].add, txmsg)) {
	      if (txmsg.step.game != 0) {
	        if (game_self.game.id === txmsg.game_id) {
//console.log("pushing move onto future stack 1!");
//console.log("PUSHING BACK: " + JSON.stringify(txmsg.turn));
	          game_self.game.future.push(JSON.stringify(tx.transaction));
	        }
	        game_self.saveFutureMoves(game_self.game.id);
	        console.log("FUTURE MOVES: " + JSON.stringify(game_self.game.future));
...
//console.log("active --> " + this.gaming_active);
	      ...
	      if (game_self.game.id === txmsg.game_id) {
//console.log("pushing move onto future stack 2!");
//console.log("PUSHING BACK: " + JSON.stringify(txmsg.turn));
	        game_self.game.future.push(JSON.stringify(tx.transaction));
	      }
	      game_self.saveFutureMoves(game_self.game.id);
...
console.log("PLAHER: " + game_self.game.player);
...
console.log("done executing: " + cont);
console.log(" and queue is: " + this.game.queue);
	} else {
...
console.log("SAVING FUTURE MOVES: " + game_id);
