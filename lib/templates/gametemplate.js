...
console.log("is this the first flip? yes");
...
console.log("getting the keys: " + cardnum);
...
console.log("decryption keys needed: " + decryption_keys_needed);
console.log("decryption keys available: " + game_self.game.pool[poolidx-1].decrypted);
