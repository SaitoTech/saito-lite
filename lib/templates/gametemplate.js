...
//
// previously offchain restricted to 2-player games -- changed March 15
//
//        if (relay_mod != null && (game_self.game.initializing == 0 || (game_self.initialize_game_offchain_if_possible == 1 && game_self.game.players.length == 2))) {
