...
console.log("generated future move...: " + JSON.stringify(ftxmsg));

                if (ftxmsg.step.game == (game_self.game.step.game+1) && ftxmsg.game_id == game_self.game.id) {
                  game_self.game.future.splice(ii, 1);
console.log("executing move that arrived while we were waiting..." + JSON.stringify(ftx));
...
console.log(ftxmsg.step.game + " -- " + game_self.game.step.game + " ---> " + JSON.stringify(ftxmsg));
