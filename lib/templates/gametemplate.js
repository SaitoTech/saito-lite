...
console.log("we have found pending transactions while reloading this game...");

      let tmptx = new saito.transaction(JSON.parse(this.app.wallet.wallet.pending[i]));
      try {
        let txmsg = tmptx.returnMessage();
console.log("txmsg.module: " + txmsg.module);
...
console.log("loading game self");

            let game_self  = this.app.modules.returnModule(txmsg.module);

console.log("PENDING GAME_ID: " + txmsg.game_id);
...
console.log("#############");
console.log("#############");
console.log("SAVING GAME ID: " + game_self.game.id);
          game_self.saveGame(game_self.game.id);
...
console.log("RESOLVE FLIP INFO: " + deckidx + " - " + cardnum + " - " + poolidx);
...
console.log(game_self.game.opponents.length+1);
console.log("HERE WE ARE 2");

          let decryption_keys_needed = game_self.game.opponents.length+1;

console.log("dec: " + decryption_keys_needed);
//console.log(JSON.stringify(game_self.game.pool));

          //
          // create pool if not exists
          //
console.log("TESTING: adding pool length info: " + game_self.game.pool.length + " -- " + poolidx);
...
console.log("TESTING: " + sender + " -- " + game_self.game.player);
