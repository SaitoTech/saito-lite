...
console.log("created Game Clock");
...
console.log("using clock? " + this.useClock);

    if (this.useClock == 1) {
console.log("ok, rendering the damn clock!");
      this.clock.render(app, this);
      this.clock.attachEvents(app, this);
console.log("ok, done rendering the game clock!");
    }
