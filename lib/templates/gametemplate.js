...
console.log("existing step 1: " + game_self.game.step.game);
console.log("existing step 2: " + game_self.game.step.players[tx.transaction.from[0].add]);
