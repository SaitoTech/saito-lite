...
// console.log("QUEUE 1: " + JSON.stringify(app.options.games[i].queue));
// console.log("QUEUE 2: " + JSON.stringify(game_self.game.queue));

            if (tx_processed == 0) {
console.log("MOVING INTO HANDLE GAME MOVE!");
...
console.log("following game: " + game_id + " ---- " + following_game);
...
console.log("GAME MOVE RECEIVED: " + txmsg.step.game);
console.log("GAME MOVE SENDER: " + tx.transaction.from[0].add);
console.log("GAME MOVE PLAYERS DONE: " + game_self.game.step.players);
  ...
  receiveAcceptRequest(blk, tx, conf, app) {
    ...
    //
    // if this game already has all the players it needs, then we have already accepted it
    //
    if (this.game.players_needed == this.game.players.length) {
      if (app.wallet.returnPublicKey() == originator) {

	//
	// we can never be sorry about the games WE accept
	//
...
console.log("########################");
console.log("PN: " + this.game.players_needed + " -- PL: " + this.game.players.length);
...
console.log("keyidx " + keyidx);
        ...
        if (gmv[0] === "CARDS") {
console.log("HERE WE ARE WITH CARDS: " );
          this.updateLog("exchanging cards with opponent...");
          this.updateStatus("Exchanging cards with opponent...");
          let deckidx = parseInt(gmv[1]);
          game_self.game.queue.splice(gqe, 1);
console.log("HERE WE ARE WITH CARDS 2: " );
console.log("THE DECK IS HERE: ");
console.log(JSON.stringify(game_self.game.deck));
console.log("POST DECK: ");
          for (let i = 0; i < parseInt(gmv[2]); i++) {
console.log(i + " --> of " + parseInt(gmv[2]));
console.log("GQE-1-u" + (gqe-1-i));
console.log("GQE-2: " + game_self.game.queue[gqe-1-i]);
...
console.log("POOL LOOKS LIKE WHAT? " + JSON.stringify(this.game.pool));

console.log("A 1");

console.log(deckidx + " - " + cardnum + " - " + poolidx + " - " + playerid);
console.log(" ... and my id is: " + this.game.player);
...
console.log("A 4");
          ...
          // create pool if not exists
          //
console.log("adding pool length info: " + game_self.game.pool.length + " -- " + poolidx);
          while (game_self.game.pool.length < poolidx) { game_self.addPool(); }
