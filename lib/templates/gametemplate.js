...
console.log("before he go into the queue");
...
console.log("FUTURE: " + JSON.stringify(game_self.game.future));
...
console.log(" ... sent on chain ");
  ...
  async handlePeerRequest(app, message, peer, mycallback = null) {
    ...
    if (message.request === "game relay gamemove") {
	  ...
	  //
console.log("RELAY: " + game_self.browser_active + " -- " + JSON.stringify(gametxmsg.turn));
	  if (game_self.browser_active || game_self.game.initializing == 1) {
console.log("sending into handle game move: " + gametx);
            game_self.handleGameMove(game_self.app, gametx, 1); 
console.log("and checking future moves...");
	    game_self.processFutureMoves();
	  } else {
