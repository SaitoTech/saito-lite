...
console.log("ON CONFIRMATION FOR: " + JSON.stringify(txmsg));
...
console.log("!!!!!!!!!!!!!!!!!!!!");
  ...
  startQueue() {
    //this.gaming_active = 1;
console.log("RUNNING QUEUE FIRST TIME");
    this.runQueue();
console.log("PROCESS FUTURE MOVES NOW!");
    //this.gaming_active = 0;
...
console.log("UPDATING LAST MOVE!");
...
console.log("ABOUT TO RUN QUEUE WITH NEXT MOVE?");
...
console.log("And done next move");
