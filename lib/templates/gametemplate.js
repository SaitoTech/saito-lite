...
console.log("PLAY HERE: " + game_self.game.confirms_needed);
...
console.log("PLAYERS TO GO: " + JSON.stringify(players_to_go));
console.log("CONFIRMS NEEDED: " + JSON.stringify(game_self.game.confirms_needed));
	  for (let i = 0; i < players_to_go.length; i++) {
console.log("PLAYER TURN 1: " + i);
	    if (game_self.game.player == parseInt(players_to_go[i])) {
console.log("PLAYER TURN 2 " + players_to_go[i] + " -- " + game_self.game.player);
console.log("CN: " + JSON.stringify(game_self.game.confirms_needed));
console.log("CN? " + i + " -- " + game_self.game.confirms_needed[i]);
	      if (game_self.game.confirms_needed[(players_to_go[i]-1)] == 1) {
console.log("PLAYER TURN 3");
