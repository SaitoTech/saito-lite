...
if (game_self.game.halted == 1) {
  console.log("RECEIVED MOVE BUT GAMING HALTED...: " + JSON.stringify(txmsg));
}
if (game_self.gaming_active == 1) {
  console.log("RECEIVED MOVE BUT GAMING ACTIVE (HALTED)...: " + JSON.stringify(txmsg));
}

console.log("GAME MOVE: " + JSON.stringify(game_self.game));
console.log("A");
...
console.log("PUSHING TX INTO QUEUE");
...
console.log(" pushing " + txmsg.turn[i]);
...
//
// if we have hit here, we are finished processing the move, and should save in case reload
// causes us to not process this move again...
//
//if (should_we_save == -1) {
//  console.log("SAVING AFTER RUN QUEUE ... this might cause UI issues");
//  game_self.saveGame(game_self.game.id);
//}
...
console.log("THE GAME IS NOW CREATED: ");
console.log("halted --> " + this.game.halted);
console.log("active --> " + this.gaming_active);
    return 1;
