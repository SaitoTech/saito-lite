...
console.log("ifm c");
console.log("c-1: " + txmsg.step.game);
console.log("c-2: " + game_self.game.step);
...
console.log("game accepted and initial save!");
...
console.log("heading into process future moves in game init after initializeGameFeeder");
...
console.log("function: initialize game feeder");
...
console.log("pre initialize game");

    this.initializeGame(game_id);

console.log("post initialize game - step - " + this.game.step);
  ...
  runQueue() {
	...
	loops_through_queue++;
        ...
        if (cont == 0) {
          ...
          //
console.log("processing future moves in runQueue");
          this.processFutureMoves();
console.log("done future moves in runQueue");
          return 0;
        }
      }
    }
...
console.log("function: executing process future moves.");
	  ...
	  // we are concerned about receiving moves out-of-order
 	  //
		...
		return;
          ...
          //
          if ( ( (!game_self.game) || (game_self.game.id != gametxmsg.game_id ) ) && gametxmsg.game_id != "") {
console.log("loading our game w/ id: " + gametxmsg.game_id);
...
console.log("DECK: " + JSON.stringify(game_self.game.deck));
	...
	//
	  ...
	  return 1; 
        ...
        game_self.crypto_transfer_manager.send(this.app, this, [sender], [receiver], [amount], ts, ticker, function() {
