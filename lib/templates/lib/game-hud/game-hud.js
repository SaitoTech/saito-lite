...
console.log("initial render!");
	  ...
	  // render top menu
	  //
          if (!document.querySelector(".hud-menu")) { 
...
console.log("into attach card events!");

      if (game_mod.browser_active == 0) { 
console.log("attach card events out!");
	return; 
      }
console.log("HUD MODE is: " + this.mode);
