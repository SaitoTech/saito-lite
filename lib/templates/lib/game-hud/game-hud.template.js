...
module.exports = GameHudTemplate = (hud_menu_type) => {
  ...
  return `
    ...
    <div id="hud-menu-inhud" class="hud-menu hud-menu-inhud"></div>
	  ...
	  <i id="hud-toggle-fullscreen" class="hud-toggle-fullscreen hud-toggle-fullscreen-inhud fa fa-window-maximize" aria-hidden="true"></i>
    ...
    <div class="standalone-hud-toggle-fullscreen"><i id="hud-toggle-fullscreen" class="standalone-hud-toggle-fullscreen hud-toggle-fullscreen fa fa-window-maximize" aria-hidden="true"></i></div>
  `;
}
