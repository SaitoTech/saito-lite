...
const hammer = require('../../../helpers/hammer');
...
module.exports = GameHammerMobile = {
  ...
  render : function(app, data, attachTo ="body") {},

  attachEvents : function(app, data, target = ".gameboard") {
    ...
    hammertime.on('pinchstart', function(e) {
      ...
      hammer_self.pinchZoomOrigin = hammer_self.getRelativePosition(element, { x: pinchStart.x, y: pinchStart.y }, hammer_self.originalSize, hammer_self.current.z);
    ...
    data.game.hammertime = hammertime;
