...
console.log("---------------------");
  ...
  returnPreferredCrypto() {
    ...
    if(this.wallet.preferred_crypto === "DOT" || this.wallet.preferred_crypto === "KSM" || this.wallet.preferred_crypto === "WESTIE" || this.wallet.preferred_crypto === "SaitoCrypto"){
