...
console.log("BEFORE THIS OUR INPUTS ARE: " + JSON.stringify(this.wallet.inputs));

    this.wallet.inputs.splice(pos, 0, x);
    this.wallet.spends.splice(pos, 0, 0);

console.log("AFTER THIS OUR INPUTS ARE: " + JSON.stringify(this.wallet.inputs));
...
***REMOVED***///////////
    ...
    ***REMOVED***
    ***REMOVED*** TODO: reimplement resetting archives
    ***REMOVED***
