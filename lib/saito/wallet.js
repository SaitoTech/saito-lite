...
console.log("setting preferred crypto 1");
    if (cryptomod != null) {
console.log("setting preferred crypto 2");
      if (cryptomod.renderModalSelectCrypto() != null) {
console.log("setting preferred crypto 3 -- render modal");
        let modal_select_crypto = new ModalSelectCrypto(this.app, cryptomod);
console.log("setting preferred crypto 4");
        modal_select_crypto.render(this.app, cryptomod);
console.log("setting preferred crypto 5");
        modal_select_crypto.attachEvents(this.app, cryptomod);
console.log("setting preferred crypto 6");
      }
    }
