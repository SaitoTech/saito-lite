...
console.log("####################");
  ...
  createUnsignedTransaction(publickey="", amt=0.0, fee=0.0) {
    ...
    //
    if (this.wallet.inputs.length > 10) {
...
console.log("---------------------");
  ...
  getSupportedCryptos() {
    let modules = this.app.modules.requestInterfaces("is_cryptocurrency");
  ...
  getCryptoModuleInterfaceByName(modname) {
    if(modname === "SaitoCrypto") {
      ...
      return this.app.modules.returnModule(modname).requestInterface("is_cryptocurrency");
    }
  }
