...
console.log("---------------------");
  ...
  receivePayment(senders=[], receivers=[], amounts=[], timestamp, mycallback, ticker, tries = 12, pollWaitTime = 5000) {
    ...
    return new Promise((resolve, reject) => {
      ...
      let poll_check_payment_function = async() => {
        console.log("poll_check_payment_function...");
      ...
      if(receivers[0] === cryptomod.returnAddress()) {
        console.log("it's me!! where's my money??");
        poll_check_payment_function();
      } else {
