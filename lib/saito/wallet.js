...
console.log(err);
  ...
  signTransaction(tx) {
    ...
    for (let i = 0; i < tx.transaction.to.length; i++) { tx.transaction.to[i].from = "" }
    for (let i = 0; i < tx.transaction.from.length; i++) { tx.transaction.from[i].from = "" }
