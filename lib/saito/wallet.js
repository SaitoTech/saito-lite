...
console.log("send payment 4");
  ...
  async receivePayment(senders=[], receivers=[], amounts=[], timestamp, mycallback=null, ticker) {
    ...
    //
    // otherwise check to see if it has come in...
    //
    ...
    if (!has_payment_been_received) {
	  ...
	  // and exit
	  //
console.log("success receiving payment!");
      ...
      // and exit
      //
console.log("success receiving payment2!");
