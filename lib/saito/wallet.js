...
console.log("submiting with: " + publickey + " - and = " + amt);
...
console.log(total_fees.toFixed(8) + " -- " + wallet_avail.toFixed(8));
...
***REMOVED***
    ...
    //
console.log("TF: " + total_fees.toFixed(8));
...
***REMOVED***
console.log("IN PROESS: " + JSON.stringify(tx.transaction.from));
