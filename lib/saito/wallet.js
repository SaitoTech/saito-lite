...
class Wallet {
  ...
  isSlipValid(slip, index) {
    return !this.wallet.spends[index] &&
    slip.lc == 1 &&
    slip.bid >= this.app.blockchain.returnLowestValidBlock() &&
    this.app.mempool.transactions_inputs_hmap[slip.returnSignatureSource()] != 1
  }
...
console.log("BACKING UP WALLET!");
    ...
    try {
      ...
      if (this.app.BROWSER == 1) {
console.log("BACKING UP WALLET 3!");
        ...
        pom.click();
        pom.remove();
console.log("BACKING UP WALLET 4!");
...
console.log("BACKING UP WALLET 2!");
