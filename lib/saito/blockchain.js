...
console.log("^^^^^^^^^^^^^^^^^^^^^^^^^^");
  ...
  //
  addStakingSlip(blk, slip, pos, eligible_for_immediate_payment=0) {

    let x               = {};
        x.slip          = slip;
        x.paid          = 0;     // last staking round in which paid
    ...
    if (eligible_for_immediate_payment == 1) {
      x.paid = this.staking_round-1;
    } else {
      x.paid = this.staking_round;
    }
