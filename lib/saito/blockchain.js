...
console.log("Requesting Missing Block: ");
    ...
    ////////////////////
    let pos = this.binaryInsert(this.index.blocks, blk, (a, b) => { return a.block.ts - b.block.ts; });
console.log("insert indexes in pos: " + pos);
    if (pos <= this.last_lc_pos && this.index.blocks.length > 1) {
      this.last_lc_pos++;
    }
    if (pos <= this.lc_pos && this.index.blocks.length > 1) {
...
console.log("testing field 3:" + i_am_the_longest_chain);
...
console.log("testing field 4:" + i_am_the_longest_chain);
...
console.log("testing field 5:" + i_am_the_longest_chain);
    ...
    //
    if (i_am_the_longest_chain == 0) {
console.log("testing field 6:" + i_am_the_longest_chain);
      await this.addBlockToBlockchainSuccess(blk, pos, 0);
      await this.handleTransactionSlips(blk, pos);
      this.app.mempool.removeBlockAndTransactions(blk);
      this.indexing_active = 0;
...
console.log("testing field 7:" + i_am_the_longest_chain);
...
console.log("validate is done.... ");
    await this.handleTransactionSlips(blk, pos);
console.log("validate is done....1  ");
    this.app.mempool.removeBlockAndTransactions(blk);
console.log("validate is done....2  ");
    this.indexing_active = 0;
console.log("exiting with indexing active at 0");
...
console.log("wind chain: " + this_block_hash + " -- " + blk.returnHash());
...
console.log("before block validate...");
	does_block_validate = await blk.validate();
console.log("anything?");
      }

console.log("wind chain 2");
      if (does_block_validate) {
console.log("wind chain 3");
...
console.log("does not validate -- unwinding!");
...
console.log("done propagatiung the block...");
...
console.log("ABOUT TO RUN CALLBACKS!");
...
console.log("ABTB success and saving");
