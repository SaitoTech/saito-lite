...
console.log("picked: " + winner_pos + " -- " + winner_sid + " ----- is spent ----> " + is_slip_spent);
...
console.log("winner slip is: " + JSON.stringify(winner_slip));
    }
