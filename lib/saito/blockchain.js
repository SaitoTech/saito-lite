...
console.log("Last BSH: " + this.last_bsh);
...
console.log("Setting LXC 3");
          i_am_the_longest_chain = 1;
        }
***********************/

console.log("last bid: " + this.index.blocks[this.lc_pos] + " (" + this.lc_pos + ") " + blk.block.id);
...
console.log("stakers length is: " + this.index.stakers[pos].length);
 	  this.index.stakers[pos][i].paid = -1;
        }
      } catch (err) {
