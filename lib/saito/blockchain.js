...
console.log("stakerslen + ------> " + this.index.stakers[winner_pos].length);
    ...
    //
    if (is_slip_spent == 0) {
console.log("randomly picked winner!");
    ...
    //
      ...
      let p = this.returnBlockPos(earliest_bid);
      let cont = 1;

console.log("earliest: " + p);
console.log("block id there is: " + this.index.blocks[p].block.id);
...
console.log("winner_bid: " + winner_bid);
console.log("winner_sid: " + winner_sid);
