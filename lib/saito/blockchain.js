...
console.log("ON INITIALIZATION: " + JSON.stringify(this.app.options.blockchain));
...
console.log("JUST ASSIGNED: " + JSON.stringify(this.app.options.blockchain));
...
console.log("setting 1 to : " + this.genesis_ts);
    this.app.options.blockchain.genesis_ts		= this.genesis_ts;
console.log("setting 2 to : " + this.genesis_bid);
    this.app.options.blockchain.genesis_bid		= this.genesis_bid;
console.log("setting 3 to : " + this.genesis_period);
...
console.log("\n\n\nSAVING BLOCKCHAIN: " + JSON.stringify(this.app.options.blockchain));
