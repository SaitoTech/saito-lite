...
console.log("last bid: " + this.last_bid);
console.log("last ts : " + this.last_ts);
console.log("last bf : " + this.last_bf);
    ...
    if (pos <= this.lc_pos && this.index.blocks.length > 1) { this.lc_pos++; }


console.log("inserted block into pos: " + pos);

console.log("this.lc is now: " + this.lc_pos);
    /////////////////////
    // update hashmaps //
    /////////////////////
...
console.log("This can be longest chain too!");
...
console.log("HERE A: " + blk.block.id + " -- " + this.lc_pos);
...
console.log("last block hash: " + lblk.returnHash());
...
console.log("Here: " + i_am_the_longest_chain);
...
console.log("Here not forced: " + this.run_callbacks);
...
console.log("running the callbacks!");
	  ...
	  our_longest_chain.reverse();
	    ...
	    //
            ...
            if (blk != null) {
              await blk.runCallbacks(our_longest_chain_len-i-1);
    	    }
  	  }
        }
