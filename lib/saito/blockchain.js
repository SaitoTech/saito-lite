...
// insert paths
  ...
  */
  updateGenesisBlock(blk, pos) {
    ...
    if (blk.block.id >= ((this.genesis_bid * 2) + 1)) {

      let purge_id = blk.block.id - (this.genesis_bid*2);
      this.genesis_bid = blk.block.id - (this.genesis_bid);
