...
console.log("\n\n\n------------------------INDEX LENGTH: " + this.index.stakers.length + "\n------------------------");
...
console.log("unsetting indexing active in AHTB");
    this.indexing_active = 0;
    return;
...
console.log("we think this should go in position: " + pos);
console.log("lens: " + this.index.blocks.length + " -- " + this.index.stakers);
...
console.log("COMMON ANCESTOR FOUND AT POS: " + shared_ancestor_pos);
		...
		new_chain_pos.push(search_pos);
              ...
              if (shared_ancestor_pos == 1) {
                if (nchain_prevbsh == "") {
                  ...
                  console.log("A 1 - pos: " + pos + " --- " + this.index.stakers.length);
...
console.log("do we switch? " + nchain_len + " - " + lchain_len + " - " + nchain_bf + " - " + lchain_bf);
...
console.log("are we the longest chain? " + i_am_the_longest_chain);
...
console.log("about to head into validate...");
    await this.validate(
      blk,
      pos,
    ...
    this.app.mempool.removeBlockAndTransactions(blk);
    this.indexing_active = 0;
console.log("indexing active set to zero...");
...
console.log("\n\nFINISHED LOADING BLOCKS FROM DISK!\n\n");
console.log("is indexing active? " + this.indexing_active);
...
console.log("handling TX slips for: " + pos + " - " + blk.block.id);
...
console.log("slip: " + JSON.stringify(newslip));
...
console.log("BLOCKPOS: " + pos + " and index length: " + this.index.stakers.length);
...
console.log(" ... and winnerNum: " + winnerNum);
    let winner_pos = (winnerNum % modlength);
console.log(" ... and winnerPos: " + winner_pos);
    let winner_bid = -1;
    let winner_sid = -1;
...
console.log("winner_pos: " + winner_pos);
...
console.log("how many stakers in this pos: " + this.index.stakers[winner_pos].length);
...
console.log("is the slip from this block unspent? " + is_slip_spent);
...
console.log("RETURN SOME RESULTS!");
    return results;
  } 
