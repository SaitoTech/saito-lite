...
console.log("NCB: " + JSON.stringify(new_chain_bsh));
console.log("OCB: " + JSON.stringify(old_chain_bsh));
...
/***
    ...
    //
    // check if anything points back to it
    //
    if (pos < this.index.stakers.length+1) {
	  ...
	  //
	  // our next will be their (disconnected) first, so connect
	  //  
	  x.next_bid = this.index 
