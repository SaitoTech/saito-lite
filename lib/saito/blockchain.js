...
/***
      ...
      // old staking slips
      //
      if (blk.transactions[i].transaction.type == 2) {
	if (blk.transactions[i].transaction.to[ii].type == 4) {
          this.app.shashmap.spend_slip(slip, bid);
	}
      }
***/
...
console.log("post cycle down");
    ...
    winner_sid = (winnerNum2 % this.index.staking[winner_pos].length);
    let winner_slip = this.index.staking[winner_pos][(winnerNum2 % this.index.staking[winner_pos].length)];
