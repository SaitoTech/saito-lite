...
console.log("CALCULATING WITH MODLENGTH: " + modlength);
    //
...
console.log("winnernum is " + winnerNum);
...
console.log("winnerSid2 =---->    " + winner_sid);

//console.log("SLIPS ARE: " + JSON.stringify(this.index.stakers[winner_pos][winner_sid]));
...
console.log("marking slip as spent: ");
console.log(winner_pos + " -- " + winner_sid);
//console.log(JSON.stringify(this.index.stakers[winner_pos][winner_sid]));
        is_slip_spent = 1;
      }
    }
    ...
    //
    if (is_slip_spent == 0) {
console.log("WINNER POS: " + winner_pos + " -- picked an unpaid slip");
...
console.log("STKR PAID more than staking round...: " + stkr.paid + " -- " + this.staking_round);
...
console.log("ERROR HERE: " + pos_of_last_staking_block + " -- " + sid_of_last_staking_block);
	  //
	  // winner
	  //
