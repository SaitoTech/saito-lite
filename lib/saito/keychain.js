...
console.log("returning identicon " + JSON.stringify(this.keys[x].data));
...
***REMOVED***
    ...
    //
    let options = {
      foreground: [0, 0, 0, 255],       ***REMOVED*** rgba black
      background: [255, 255, 255, 255], ***REMOVED*** rgba white
      margin: 0.2,                      ***REMOVED*** 20% margin
      size: 420,                        ***REMOVED*** 420px square
      format: 'svg'                     ***REMOVED*** use SVG instead of PNG
***REMOVED***;
    let data = new Identicon(publickey, options).toString();
    let img = '<img width=420 height=420 src="data:image/svg+xml;base64,' + data + '" />';
