...
console.log("BEING ASKED TO UPDATE IDENTICON: " + identicon + " for " + publickey)
    if (this.keys != undefined) {
      for (let x = 0; x < this.keys.length; x++) {
        if (this.keys[x].publickey === publickey) {
	  if (!this.keys[x].data) { this.keys[x].data = {}; }
console.log("UPDATING THE IDENTICON!");
...
console.log(" 1 returning identicon for: " + publickey);
    if (this.keys != undefined) {
console.log(" 2 returning identicon for: " + publickey);
      for (let x = 0; x < this.keys.length; x++) {
console.log(" 3 returning identicon for: " + publickey);
        if (this.keys[x].publickey === publickey) {
console.log(" 4 returning identicon for: " + publickey + " at key: " + x);
console.log(JSON.stringify(this.keys[x]));
console.log(" 4 - 1 " + this.keys[x].data.identicon);
console.log(" 4 - 2 " + (typeof this.keys[x].data.identicon));
          if (this.keys[x].data.identicon != "" && typeof this.keys[x].data.identicon !== "undefined") {
console.log(" 5 returning identicon for: " + publickey);
