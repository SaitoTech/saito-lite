...
console.log("UIMODS LENGTH: " + this.uimods.length);
...
console.log("REMOVING MOD: " + this.mods[z].name);
    ...
    //
    for (let i = 0; i < this.mods.length; i++) {
console.log("initializing: " + this.mods[i].name);
  ...
  updateIdentifier() {
    for (let i = 0; i < this.mods.length; i++) {
console.log("into update identifier for: " + this.mods[i].name);
