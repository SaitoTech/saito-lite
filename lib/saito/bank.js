...
class Bank {
  ...
  returnWinner(gt, already_selected_stakers=[]) {
    ...
    if (this.deposits.length == 0) {
      return { publickey : gt.publickey , updated_selected_stakers : already_selected_stakers }
    }
    ...
    return { publickey : this.deposits[ending_pos].slip.add, updated_selected_stakers : already_selected_stakers }
  }
