...
class Bank {
  ...
  constructor(app) {
    ...
    this.current 			= []; // array of staking UTXO
    this.current_sig_pos_hmap		= []; // maps slip sig to pos in current
    this.current_bsh_posarray_hmap  	= []; // maps bsh to array of pos in current

    this.pending 			= []; // array of staking UTXO
    this.pending_sig_pos_hmap		= []; // maps slip sig to pos in pending
    this.pending_bsh_posarray_hmap  	= []; // maps bsh to array of pos in pending

    this.reimbursement_amount = 10;
