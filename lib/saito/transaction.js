...
***REMOVED***
  ...
  ***REMOVED***
  ...
  generateRebroadcastTransaction(creator, tid, sid, avg_fee=2) {
    ...
    // rebroadcasts //
    //////////////////
    if (this.transaction.type == 3) { fee = Big(0); ***REMOVED***
    if (
      this.transaction.type == 0 || 
      ...
      //
      if (this.transaction.type == 3) { newtx.transaction.type = 3; ***REMOVED***

      //
      // staking transactions marked current or pending
      //
      if (this.transaction.type == 4) { newtx.transaction.type = 6; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  isRebroadcast(oldblk, newblk, sid) {
    ...
    if (this.transaction.to[sid].add == this.atr_trapdoor) { return false; ***REMOVED***

    // vip transactions always rebroadcast
    if (this.transaction.type == 3)      { return true; ***REMOVED***

    // golden chunk always rebroadcast
    if (this.transaction.type == 8)	 { return true; ***REMOVED***
