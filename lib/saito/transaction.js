...
class Transaction {
  ...
  returnSignatureSource(app) {
    // return this.transaction.sig;
    return `${JSON.stringify(this.transaction.from)}${JSON.stringify(this.transaction.to)}${this.transaction.ts}${this.transaction.type}${this.transaction.r}${JSON.stringify(this.transaction.msg)}${this.transaction.ps}`;
  }
