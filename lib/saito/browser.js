...
class Browser {
  ...
  logMatomoEvent(category, action, name = null, value = null) {
    try {
  ...
  logMatomoEventAndNavigate(location, category, action, name = null, value = null) {
    this.logMatomoEvent(category, action, name, value);
