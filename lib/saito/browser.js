...
console.log("TARGET MDOWN: " + e.currentTarget.id);

        if (e.currentTarget.id != id_to_move && e.currentTarget.id != id_to_drag) {
...
console.log("TARGET UP: " + e.currentTarget.id);
          document.onmouseup = null;
          document.onmousemove = null;
...
console.log("TARGET MVE: " + e.currentTarget.id);
...
console.log("T TARGET DOWN: " + e.currentTarget.id);
        e = e || window.event;
        //e.preventDefault();
        if (e.stopPropagation) { e.stopPropagation(); }
        if (e.preventDefault) { e.preventDefault(); }
...
console.log("T TARGET UP: " + e.currentTarget.id);
          document.onmouseup = null;
          document.onmousemove = null;
          if (mycallback != null) { if (element_moved == 1) { mycallback(); } }
        };
...
console.log("T TARGET MVE: " + e.currentTarget.id);
