...
***/
  ...
  returnInviteLink(email="") {
    ...
    let link = this.app.options.peers[0].protocol + 
	       '://' + 
               this.app.options.peers[0].host +
	       ':' + 
               this.app.options.peers[0].port +
	       '/r?i=' +
               encodeURIComponent(this.app.crypto.stringToBase64(JSON.stringify(this.returnInviteObject()))) +
	       '&z=132';
    return link;
  }
