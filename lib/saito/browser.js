...
Browser.prototype.initialize = function initialize() {
  ...
  try {
    ...
    let active_module = myurlpath[1];

    //
    // tell that module it is active
    //
    for (let i = 0; i < this.app.modules.mods.length; i++) {
      if (this.app.modules.mods[i].name.toLowerCase() == active_module) {
...
***REMOVED***
    ...
    //
    //for (let m = 0; m < this.app.modules.mods.length; m++) {
    ...
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker
             .register('/saito/sw.js')
             .then(function() { console.log("Service Worker Registered"); ***REMOVED***);
***REMOVED***
...
Browser.prototype.checkForMultipleWindows = function checkForMultipleWindows() {
