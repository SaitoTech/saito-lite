...
***REMOVED***
  ...
  ***REMOVED***
          ...
          let slips = [];
  ***REMOVED*** for (let i = 0; i < payments.blocks.length; i++) {
      ...
      ***REMOVED***);
    ***REMOVED*** let {
    ***REMOVED***   producer_share,
    ***REMOVED***   miner_share,
    ***REMOVED***   router_share,
    ***REMOVED***   staker_share,
    ***REMOVED***   producer_publickey,
    ***REMOVED***   miner_publickey,
    ***REMOVED***   router_publickey,
    ***REMOVED***   staker_publickey,
    ***REMOVED*** ***REMOVED*** = payments.blocks[i];
...
***REMOVED***
  ...
  ***REMOVED***
  ***REMOVED*** all rebroadcast TXS can be identified by tx field
  ***REMOVED***
  ...
  returnEmbeddedRoutingWork() {
    ...
    for (let i = 0; i < this.transactions.length; i++) {
      if (this.transactions[i].is_valid == 1) {
        ...
        console.log("\n\nAVAILABLE WORK IN RETURN EMBEDDED ROUTING WORK: ", available_work);
        if (this.transactions[i].transaction.type == 1) {
          if (this.transactions[i].transaction.msg.target != this.prevbsh) {
            console.log("\n\nSETTING AVAILABLE WORK TO ZERO");
            available_work = Big(0);
      ***REMOVED***
    ***REMOVED***

        console.log("\n\nADDING WORK TO EMBEDDED WORK");
...
***REMOVED***
    ...
    ***REMOVED***
            ...
            let slips = [];
    ***REMOVED*** for (let x = 0; x < payments.blocks.length; x++) {
    ***REMOVED***   let {
    ***REMOVED***     producer_share,
    ***REMOVED***     miner_share,
    ***REMOVED***     router_share,
    ...
    ***REMOVED***   if (producer_share > 0) {
    ***REMOVED***     slips.push(new saito.slip(producer_publickey, producer_share, 1));
    ***REMOVED***   ***REMOVED***
    ***REMOVED***   if (miner_share > 0) {
    ***REMOVED***     slips.push(new saito.slip(miner_publickey, miner_share, 1));
    ***REMOVED***   ***REMOVED***
    ***REMOVED***   if (router_share > 0) {
    ***REMOVED***     slips.push(new saito.slip(router_publickey, router_share, 1));
    ***REMOVED***   ***REMOVED***
    ***REMOVED***   if (staker_share > 0) {
    ***REMOVED***     slips.push(new saito.slip(staker_publickey, staker_share, 1));
    ***REMOVED***   ***REMOVED***
    ***REMOVED*** ***REMOVED***
            payments.blocks.forEach((block) => {
              if (block.producer_share > 0) {
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  returnBlockPayouts(gt=null, rvalue={***REMOVED***, rloop=0) {
...
***REMOVED***
    ...
    try {
      ...
      console.log("TOTAL WORK AVAILABLE: ", total_work_available);
...
***REMOVED***
    ...
    console.log("CALCULATE PAYMENTS: ", payments);
