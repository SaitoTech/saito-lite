...
console.log("length of txs: " + this.transactions.length);

console.log("in bundle block 6");
...
console.log("And bundling with 9");
...
console.log("post signing tx");
            this.transactions.push(newtx);

      }
    }

console.log("And bundling with 10");
    //
    // merkle root
    //
    this.block.merkle = this.returnMerkleRoot();

console.log("done bundle block");
...
console.log("running callbacks in blk: " + this.block.id);
...
for (let i = 0; i < this.transactions.length; i++){
  if (this.transactions[i].transaction.type == 2) {
console.log(JSON.stringify(this.transactions[i].transaction.to));
  }
}
...
console.log("Adding a Block Payment!");
...
console.log("SRouter:   " + payments.srouter_share);
		...
		//
console.log("block_st 1: " + block_st);
                block_st = Big(block_st).plus(Big(payments.staker_share)).toFixed(8);
console.log("adding: " + payments.staker_share);
                block_st = Big(block_st).minus(Big(normalized_staker_payout));
console.log("subtract: " + normalized_staker_payout);
console.log("block_st 2: " + block_st);
...
console.log("IN BLOCK PAyments 1");
...
console.log("IN BLOCK PAyments 2");
...
console.log("IN BLOCK PAyments 3");
...
console.log("IN BLOCK PAyments 4");
    ...
    //
console.log("IN BLOCK PAyments 5");
...
console.log("IN BLOCK PAyments 6");
...
console.log("IN BLOCK PAyments 7");

      //
      // assign winners
      //
      if (winning_tx_idx == -1) {
console.log("IN BLOCK PAyments 8a");
...
console.log("IN BLOCK PAyments 8b");
...
console.log("IN BLOCK PAyments 8c");
        //
...
console.log("IN BLOCK PAyments 9");
...
console.log("IN BLOCK PAyments 10");
...
console.log("IN BLOCK PAyments 11");
...
console.log("IN BLOCK PAyments 12");

console.log("prevblk tx length: " + prevblk.transactions.length);
console.log("post length calc");
...
console.log("IN BLOCK PAyments 13");
...
console.log("IN BLOCK PAyments 14");

          srouter_publickey = winning_tx.transaction.from[0].add;

        } else {

console.log("IN BLOCK PAyments 15");
...
console.log("IN BLOCK PAyments 16");
