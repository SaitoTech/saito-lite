...
console.log("#1: " + JSON.stringify(eblkd.rebroadcast[i].transaction)); 
console.log("#2: " + JSON.stringify(this.transactions[atr_idx].transaction));
	...
	for (let i = atr_idx; i > 0; i--) {
	  if (
	    this.transactions[atr_idx].transaction.type == 5 ||
	    this.transactions[atr_idx].transaction.type == 6 ||
	    this.transactions[atr_idx].transaction.type == 7 ||
	    this.transactions[atr_idx].transaction.type == 5
	  ) {
