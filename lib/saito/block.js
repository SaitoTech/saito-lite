...
console.log("golden ticket does not solve previous block, so this isn't valid...");
          this.is_valid = 0;
          return this;
        }
...
console.log("starting with tx:idx " + i);
...
console.log("fully synced payment calculation...");
...
console.log("done xxr1");
            }
console.log("done xxr2");

            for (let x = 0; x < slips.length; x++) { slips[x].sid = x; }
console.log("done xxr3");

          }
console.log("done xxr4");
	}
console.log("done xxr5");
      }
...
console.log("not dead yet -- return 0");
          return 0;
        }
...
console.log("about to validate txs...");
console.log("which tx? "+JSON.stringify(this.transactions[i]));
      //
...
console.log("done validating this tx");
    }

console.log("not dead yet 4");
