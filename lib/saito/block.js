...
console.log("PAUYIN OUT: " + JSON.stringify(slips));
...
console.log(" st " + block_st + " -- " + this.block.st); // this validates perfectly
  ...
  async calculateBlockPayments(gt=null) {
    ...
    if (Big(router_share).gt(0)) {
      ...
      //
console.log("TXS 132");
console.log("HASH: " + this.returnHash());
