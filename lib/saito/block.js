...
console.log("BUNDLING MONETARY POLICY");
...
console.log("BUNDLING MONETARY POLICY - gt");
console.log(golden_ticket_solution);
console.log("staker share: " + payments.staker_share);
...
console.log("FOUND FEE TRANSACTION!");
...
console.log(" ss " + block_ss + " -- " + this.block.ss);
console.log(" sa " + block_sa + " -- " + this.block.sa);
console.log(" st " + block_st + " -- " + this.block.st);
