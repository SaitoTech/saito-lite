...
console.log("GOLDEN TICKET: " + this.containsGoldenTicket());
    ...
    if (prevblk != null) {
      ...
      // reset the staking slip to unspent as calculateBlockPayments does not
...
console.log("RESET STAKER TO 0 at: " + payments.staker_pos + " -- " + payments.staker_sid);
      }
      let slips = [];
...
console.log(i + " TX ID is: " + this.transactions[i].transaction.id);
