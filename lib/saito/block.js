...
console.log("Normalized Staker Payout: " + normalized_staker_payout);
      ...
      //
      // reset staking slip to unspent as calculateBlockPayments does not
      //
      if (payments.staker_pos != -1) { 
        //
        // mark as spent
        //
...
console.log("hash of slips: " + this.app.crypto.hash(JSON.stringify(slips)));
console.log("hash of txs to: " + this.app.crypto.hash(JSON.stringify(this.transactions[index_of_block_payment].transaction.to)));
