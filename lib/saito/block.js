...
console.log("CALCULATING PREVIOUS BLOCK PAYMENTS using GT");
console.log("( staking table is "+this.app.blockchain.stakers_current+")");
...
console.log("updated staking round");
    	  }
...
console.log("entered return block payouts : " + rloop);
    ...
    if (rloop == 0) {
      ...
      if (this.stakers_current == 0 && rloop == 1) {
        ...
        if (this.stakers_pending == 0) { return results; }
        ...
        this.staking_round_max_bid[this.staking_round] = this.last_bid;
