...
console.log("this.block.st at start: " + this.block.st);
//console.log("this.block.st minus: " + this.sc);
	...
	if (this.containsGoldenTicket() == 1 && this.block.id > 1) {
	  ...
	  //
	    ...
	    //
console.log("bundle block.st 1: " + this.block.st);
	    this.block.st = Big(this.block.st).plus(Big(payments.staker_share)).minus(normalized_staker_payout).toFixed(8);
console.log("bundle adding: " + payments.staker_share);
console.log("bundle subtract: " + normalized_staker_payout);
console.log("bundle block.st 2: " + this.block.st);
...
console.log("block_st 2: " + block_st);
		...
		this.app.blockchain.lowest_unspent_bid = this.app.blockchain.index.blocks[payments_staker_pos].block.id;
