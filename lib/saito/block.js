...
***REMOVED***
  ...
  ***REMOVED***
      ...
      if (expiring_data.total_rebroadcast != needs_rebroadcast) {
        expiring_data.validates = false;
  ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  returnBlockPayouts(gt=null, rvalue={***REMOVED***, rloop=0, already_selected_stakers=[]) {
...
***REMOVED*** else {
      ...
      // winning staker
      //
      let x = this.app.bank.returnWinner(gt, already_selected_stakers);
      already_selected_stakers = x.updated_selected_stakers;
