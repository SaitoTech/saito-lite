...
class GameHud {
	...
	let image_height = image_width * 1.53;
...
console.log("HE HAVE STATUS AND CARDBOX");
...
console.log("sbx is: " + status_box_height);
...
console.log("new height is: " + new_height + " and header height is " + hud_header_height); 

      if (new_height < max_height) {
console.log("style as A");
...
console.log("style as B: " + hud_height);
        hud_body.style.height = hud_height + "px";
        hud_body.style.minHeight = hud_height + "px";
        hud_body.style.maxHeight = hud_height + "px";
      }

console.log("final height set as: " + hud_body.style.height);
