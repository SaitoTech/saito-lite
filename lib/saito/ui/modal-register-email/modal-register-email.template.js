  ...
  <div class="welcome-modal-wrapper">
    <div class="welcome-modal-action">
      <div class="welcome-modal-left">
        <div class="welcome-modal-header">Hookup Your Email Address:</h1></div>
        <div class="welcome-modal-main">
          <div style="margin:1em 0">You have tokens in your wallet. Email yourself an encrypted backup?</div>
      ...
      <button id="backup-email-button" style="clear:both; margin:unset; margin-left:0px; min-width:6em; font-size:0.7em;">EMAIL BACKUP</button>
          ...
          <div style="font-size:0.9em;height:30px;margin-top:10px"><input type="checkbox" id="signup" style="float:left;width:2em;height:2em;margin-right:10px" checked /> send periodic updates on important Saito news (max monthly)</div>
        </div>
        <div class="welcome-modal-info">
            <div class="tip"><b>How does this work? <i class="fas fa-info-circle"></i></b>
              <div class="tiptext">Your browser will encrypt your wallet and email you a copy. No-one but you will ever have access to your private keys.</div>
            </div>
          </div>
      </div>
    </div>
