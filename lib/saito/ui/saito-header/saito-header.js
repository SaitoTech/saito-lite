...
class SaitoHeader extends UIModTemplate {
    ...
    async renderBalance(app, mod) {
      document.getElementById("header-balance").innerHTML = await app.wallet.returnCryptoBalance();
      document.getElementById("header-token").innerHTML = " " + app.wallet.returnPreferredCrypto();
    }
