...
class SaitoHeader extends UIModTemplate {
    ...
    async renderBalance(app, mod) {
      document.getElementById("header-balance").innerHTML = (await app.wallet.returnCryptoBalance() + ' <span style="text-weight: normal">' + app.wallet.returnPreferredCrypto() + '</span>');
    }
