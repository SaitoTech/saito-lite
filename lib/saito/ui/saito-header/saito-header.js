  ...
  attachEvents(app, mod) {
    ...
    document.querySelectorAll('#header-logo-link').forEach((element) => {
      element.onclick = (event) => {
        ...
        if(activeModule) {
          app.browser.logMatomoEvent("Navigation", "HeaderNavigation", `${activeModule.name}NavigationClick`, "HeaderLogoHomepageLink");  
        } else {
          app.browser.logMatomoEvent("Navigation", "HeaderNavigation", `UnknownModuleNavigationClick`, "HeaderLogoHomepageLink");  
