...
console.log("run cleanup disconnect socket on peer disconnect");
...
console.log("poll peers triggering disconnected socket!");
          this.cleanupDisconnectedSocket(peer);
        }
      }
    });
...
console.log("now connected? " + this.peers_connected);
