...
***REMOVED***);
    ...
    //  ***REMOVED***
    //***REMOVED***, this.peer_monitor_timer_speed);
...
console.log("sending tx to peers...");
    this.sendTransactionToPeers(tx, outbound_message, fees, mycallback);
console.log("back from sending tx to peers...");
...
***REMOVED***
  ***REMOVED***
  ...
  sendRequestWithCallback(message, data="", callback) {
    for (let x = this.peers.length-1; x >= 0; x--) {
console.log("sending request with callback to this peer; " + this.peers[x].peer.publickey);
