...
console.log("ADDING PEER: " + JSON.stringify(this.app.options.peers[i]));
  ...
  async fetchBlocks() {
    ...
    //
console.log("fetching block: " + this.downloading_active);
...
console.log("FETCHING ZBLOCK AT URL: " + block_to_download_url);
    ...
    return new Promise((resolve, reject) => {
	  ...
	  //
	    ...
	    let blkobj = this.app.storage.convertBlockStringToHeadersAndTransactionsJSON(response);
	    let blk = new saito.block(this.app, blkobj.headers);
