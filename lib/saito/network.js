...
console.log("network peers length: " + this.peers.length);
  ...
  connectToPeer(peerjson) {
    ...
    //
    peer.connect(0);
console.log("connecting to this peer: " + peerjson);
...
console.log("entered addRemotePoeer");
    ...
    this.peers.push(peer);
    this.peers_connected++;
console.log("adding remote peer: " + this.peers.length + " / " + this.peers_connected);
console.log("socket id: " + peer,socket.id);
