...
console.log("fetch worked 3!");

            this.app.mempool.addBlock(blk);

console.log("fetch worked 4!");

            delete this.downloads_hmap[bhash];

console.log("fetch worked 5!");
