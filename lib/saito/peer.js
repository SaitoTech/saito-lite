...
class Peer {
  ...
  handleHandshakeRequest(message) {
    ...
    if (this.app.BROWSER == 1) {
      ...
      this.app.options.peers.forEach((option_peer) => {
        if (option_peer.host == peershake.peer.endpoint.host && option_peer.synctype == "none") {
          ...
          this.peer.sendblks = 0;
          this.peer.sendtxs = 0;
          this.peer.sendgts = 0;
          this.handshake.peer.synctype = "none";
          this.handshake.peer.sendblks = 0;
          this.handshake.peer.sendtxs = 0;
          this.handshake.peer.sendgts = 0;
    ...
    if (this.peer.synctype != "none" && this.peer.handshake.peer.synctype !="none") {
