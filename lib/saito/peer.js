...
class Peer {
  ...
  returnHandshake() {
    ...
    console.log("this.app.blockchain.last_bid");
    console.log(this.app.blockchain.last_bid);
  ...
  handleHandshakeRequest(message) {
    console.log("handleHandshakeRequest");
...
console.log("Peer says it is synctype none, so we don't bother to send blockchain...");
    ...
    if (this.handshake.step <= 3) {
      ...
      this.handshake.blockchain.fork_id = this.app.blockchain.fork_id;
      this.handshake.blockchain.genesis_bid = this.app.blockchain.genesis_bid;
      console.log("SEND REQUEST HANDSHAKE");
      this.sendRequest("handshake", this.handshake);
      this.app.wallet.rebroadcastPendingTransactions();
...
//    console.log("________________________________\n");
  ...
  handleTransactionRequest(message, mycallback) {
    console.log("handleTransactionRequest");
  ...
  addPathToTransaction(tx) {
    console.log("addPathToTransaction");
    console.log(this.app.wallet.returnPublicKey());
    console.log(this.returnPublicKey());
