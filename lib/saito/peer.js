...
console.log("HANDSHAKE: " + JSON.stringify(handshake.blockchain));
...
console.log("sending handshake: " + JSON.stringify(this.handshake.blockchain));
      ...
      this.socket.on('reconnect', () => {
        ...
        console.log("socket reconnection has fired 2!");
      ...
      this.socket.on('request', async (data, mycallback = null) => {
        ...
        switch(message.request) {
          case 'handshake':
console.log("received handshake msg: " + JSON.stringify(message));
...
console.log("HANDLE HANDSHAKE REQ peershake step --> " + peershake.step);
...
console.log("sending HANDSHAKE COMPLETE --- ");
...
console.log("MY LAST BID: " + my_last_bid);
console.log("LAST SHARED: " + last_shared_bid);
console.log("PEER LSBID: " + peer_last_bid);
console.log("peershake step: " + peershake.step);
