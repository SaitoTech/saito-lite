...
class Peer {
  ...
  addSocketEvents() {
	...
	//
	// this can cause problems with 0-fee txs, as they are cleared by servers and re-included, best to 
	// sendPendingTransactions only when the blockchain is fully synced in order to avoid sending
        // duplicates.
	//
