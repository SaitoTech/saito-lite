...
console.log(" .. asked to return handshake");
    ...
    if (this.app.BROWSER == 0) {
      ...
      console.log("HANDSHAKE FOR PEER SET AS:\n" + JSON.stringify(handshake.peer));
  ...
  connect(mode = 0) {
    ...
    if (mode == 0) {
      ...
      if (this.socket) {
        try {
console.log("socket already exists, so destroying the old one...");
          this.socket.destroy();
        } catch (err) {
          console.log(err);
        }
...
console.log(" .. sending handshake request");
        ...
        //
console.log(" .. emitting connection_up");
...
console.log(" .. emitting peer_disconnect");
...
console.log(" .. sending handshake request");
        ...
        // inform event channel
        //
console.log(" .. emitting connection upsending handshake request");
        this.app.connection.emit('connection_up', this);
        this.app.wallet.rebroadcastPendingTransactions();
      });
...
console.log(" .. received and processing handshake request");
    ...
    console.log(this.handshake.challenge_mine + " - " + peershake.challenge_proof + " - " + this.handshake.challenge_verified);
...
console.log("DO WE SYNC WITH THIS PEER? UES");
...
console.log(" checking if I am head of the other server... ");
...
console.log("Peer says it is synctype none, so we don't bother tp send blockchain...");
