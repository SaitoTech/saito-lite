...
console.log("received: " + JSON.stringify(message.request));
  ...
  handleAlertResetRequest(message) {
    ...
    let original_genesis_hash = message.data.original_genesis_hash;
    let original_genesis_sig = message.data.original_genesis_sig;
    let original_genesis_ts = message.data.original_genesis_ts;
