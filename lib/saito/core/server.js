...
class Server {
  ...
  initialize() {
    ...
    if (this.app.options.server != null) {
      ...
      this.server.sendblks = this.app.options.server.sendblks || 1;
      this.server.sendtxs = this.app.options.server.sendtxs || 1;
      this.server.sendgts = this.app.options.server.sendgts || 1;
      this.server.receiveblks = this.app.options.server.receiveblks || 1;
      this.server.receivetxs = this.app.options.server.receivetxs || 1;
      this.server.receivegts = this.app.options.server.receivegts || 1;
    }
