...
function startIgnoringMouse() {
    ...
    setTimeout(function () {
        ignoreMouseDepth--;
***REMOVED***, config.touchMouseIgnoreWait);
***REMOVED***
    ...
    ***REMOVED***;
        _this.handleDragEnd = function (ev) {
            ...
            ***REMOVED*** dropped within same calendar
                    ...
                    ***REMOVED***
                        var eventDropArg = __assign({***REMOVED***, transformed, { el: ev.subjectEl, delta: validMutation.datesDelta, oldEvent: eventApi, event: new EventApi(// the data AFTER the mutation
...
***REMOVED***
    ...
    var instance = createEventInstance(def.defId, { start: start, end: end ***REMOVED***);
...
export default main;
export { ExternalDraggable as Draggable, FeaturefulElementDragging, PointerDragging, ThirdPartyDraggable ***REMOVED***;
