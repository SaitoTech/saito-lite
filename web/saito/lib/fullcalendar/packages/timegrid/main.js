...
(function (global, factory) {
    ...
    (global = global || self, factory(global.FullCalendarTimeGrid = {***REMOVED***, global.FullCalendar, global.FullCalendarDayGrid));
***REMOVED***(this, function (exports, core, daygrid) { 'use strict';
    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        ***REMOVED***);
            return _this;
    ***REMOVED***
***REMOVED*** Given an array of foreground segments, render a DOM element for each, computes position,
***REMOVED*** and attaches to the column inner-container elements.
...
***REMOVED*** Computes a default `displayEventEnd` value if one is not expliclty defined
        TimeGridEventRenderer.prototype.computeDisplayEventEnd = function () {
            return true;
    ***REMOVED***;
***REMOVED*** Renders the HTML for a single event segment's default rendering
        ...
        ***REMOVED***
            return '<a class="' + classes.join(' ') + '"' +
                ...
                */
                ...
                '</a>';
    ***REMOVED***;
***REMOVED*** Given an array of segments that are all in the same column, sets the backwardCoord and forwardCoord on each.
***REMOVED*** Assumed the segs are already ordered.
***REMOVED*** NOTE: Also reorders the given array by date!
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Calculate seg.forwardCoord and seg.backwardCoord for the segment, where both values range
***REMOVED*** from 0 to 1. If the calendar is left-to-right, the seg.backwardCoord maps to "left" and
***REMOVED*** seg.forwardCoord maps to "right" (via percentage). Vice-versa if the calendar is right-to-left.
***REMOVED***
***REMOVED*** The segment might be part of a "series", which means consecutive segments with the same pressure
***REMOVED*** who's width is unknown until an edge has been hit. `seriesBackwardPressure` is the number of
***REMOVED*** segments behind this one in the current series, and `seriesBackwardCoord` is the starting
***REMOVED*** coordinate of the first segment in the series.
    ...
    ***REMOVED***;
        ...
        ***REMOVED***);
    ***REMOVED***;
***REMOVED*** Given foreground event segments that have already had their position coordinates computed,
***REMOVED*** assigns position-related CSS values to their elements.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Generates an object with CSS properties/values that should be applied to an event segment element.
***REMOVED*** Contains important positioning-related properties that should be applied to any event element, customized or not.
...
***REMOVED***(core.FillRenderer));
    ...
    ***REMOVED***
        /* Options
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Parses various options into properties of this object
    ...
    ***REMOVED***;
***REMOVED*** Computes an automatic value for slotLabelInterval
    ...
    ***REMOVED***;
***REMOVED*** Generates the HTML for the horizontal "slats" that run width-wise. Has a time axis on a side. Depends on RTL.
    ...
    ***REMOVED***;
        /* Content Skeleton
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Renders the DOM that the view's content will live in
    ...
    ***REMOVED***;
***REMOVED*** Given a flat array of segments, return an array of sub-arrays, grouped by each segment's col
        ...
        ***REMOVED***
            return segsByCol;
    ***REMOVED***;
***REMOVED*** Given segments grouped by column, insert the segments' elements into a parallel array of container
***REMOVED*** elements, each living within a column.
    ...
    ***REMOVED*** render lines within the columns
            for (i = 0; i < segs.length; i++) {
                var lineEl = core.createElement('div', { className: 'fc-now-indicator fc-now-indicator-line' ***REMOVED***);
    ...
    ***REMOVED*** render an arrow over the axis
            if (segs.length > 0) { // is the current time in view?
                var arrowEl = core.createElement('div', { className: 'fc-now-indicator fc-now-indicator-arrow' ***REMOVED***);
    ...
    ***REMOVED***;
***REMOVED*** Computes the top coordinate, relative to the bounds of the grid, of the given date.
***REMOVED*** A `startOfDayDate` must be given for avoiding ambiguity over how to treat midnight.
    ...
    ***REMOVED***;
***REMOVED*** Computes the top coordinate, relative to the bounds of the grid, of the given time (a Duration).
    ...
    ***REMOVED***;
***REMOVED*** For each segment in an array, computes and assigns its top and bottom properties
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Given segments that already have their top/bottom properties computed, applies those values to
***REMOVED*** the segments' elements.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Generates an object with CSS properties for the top/bottom coordinates of a segment element
    ...
    ***REMOVED***;
        /* Selection
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Renders a visual indication of a selection. Overrides the default, which was to simply render a highlight.
...
***REMOVED***(core.Splitter));

    var TIMEGRID_ALL_DAY_EVENT_LIMIT = 5;
    var WEEK_HEADER_FORMAT = core.createFormatter({ week: 'short' ***REMOVED***);
            ...
            _this.renderHeadIntroHtml = function () {
                ...
                if (_this.opt('weekNumbers')) {
                    ...
                    return '' +
                        ...
                        _this, { date: range.start, type: 'week', forceOff: dayCnt > 1 ***REMOVED***, core.htmlEscape(weekText) // inner HTML
                        ) +
                        '</th>';
            ***REMOVED***
                else {
    ...
    ***REMOVED*** Affects content-skeleton, mirror-skeleton, highlight-skeleton for both the time-grid and day-grid.
        ...
        ***REMOVED***;
            ...
            var timeGridEl = core.createElement('div', { className: 'fc-time-grid' ***REMOVED***);
...
***REMOVED*** The day-grid and time-grid components will render inside containers defined by this HTML.
...
***REMOVED*** renderNowIndicator(date: DateMarker) {
***REMOVED*** ***REMOVED***
    ...
    ***REMOVED***;
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Adjusts the vertical dimensions of the view to the specified values
...
***REMOVED*** given a desired total height of the view, returns what the height of the scroller should be
    ...
    ***REMOVED***;
        /* Scroll
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Computes the initial pre-configured scroll state prior to allowing the user to change it
    ...
    ***REMOVED***;
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Generates an HTML attribute string for setting the width of the axis, if it is known
