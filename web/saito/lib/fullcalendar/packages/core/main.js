...
(function (global, factory) {
    ...
    (global = global || self, factory(global.FullCalendar = {***REMOVED***));
...
***REMOVED*** must use offset(Width|Height) because compatible with client(Width|Height)
...
***REMOVED*** first-week day -- which january is always in the first week (4 for iso, 1 for other)
        var fwd = 7 + dow - doy;
***REMOVED*** first-week day local weekday -- which local weekday is fwd
...
***REMOVED*** according to web standards (and Safari), a month index is required.
***REMOVED*** massage if only given a year.
        if (a.length === 1) {
            a = a.concat([0]);
    ***REMOVED***
...
***REMOVED*** *FLOORING NOTE*: we floor in certain places because zoom can give inaccurate floating-point dimensions,
***REMOVED*** and it is better to be shorter than taller, to avoid creating unnecessary scrollbars.
...
***REMOVED*** find elements that are below the recommended height (expandable).
***REMOVED*** important to query for heights in a single first pass (to avoid reflow oscillation).
        ...
        ***REMOVED***
    ***REMOVED***);
***REMOVED*** readjust the recommended height to only consider the height available to non-maxed-out rows.
        if (shouldRedistribute) {
            availableHeight -= usedHeight;
            minOffset1 = Math.floor(availableHeight / flexEls.length);
            minOffset2 = Math.floor(availableHeight - minOffset1 * (flexEls.length - 1)); // *FLOORING NOTE*
    ***REMOVED***
***REMOVED*** assign heights to all expandable elements
...
***REMOVED*** effin' IE8/9/10/11 sometimes returns 0 for dimensions. this weird hack was the only thing that worked
...
***REMOVED***
    ...
    ***REMOVED***, dateEnv);
***REMOVED*** the recurrence plugins don't guarantee that all-day events are start-of-day, so we have to
        if (eventDef.allDay) {
...
***REMOVED***
    ...
    function mergeProps(propObjs, complexProps) {
        ...
        ***REMOVED***
    ***REMOVED***
***REMOVED*** copy values into the destination, going from last to first
...
***REMOVED*** remove existing recurring instances
...
***REMOVED***
    ...
    function invertRanges(ranges, constraintRange) {
        ...
        var i;
        var dateRange;
***REMOVED*** ranges need to be in order. required for our date-walking algorithm
    ...
    ***REMOVED*** add the span of time before the event (if there is any)
        ...
        ***REMOVED***
    ***REMOVED***
***REMOVED*** add the span of time after the last event (if there is any)
...
***REMOVED*** deal with a browser inconsistency where formatting the timezone
***REMOVED*** requires that the hour/minute be present.
        ...
        ***REMOVED***
    ***REMOVED***
***REMOVED*** only support short timezone names
        if (standardDateProps.timeZoneName === 'long') {
            standardDateProps.timeZoneName = 'short';
    ***REMOVED***
***REMOVED*** if requesting to display seconds, MUST display minutes
...
***REMOVED***
    ...
    ***REMOVED***
***REMOVED*** ^ do anything that might create adjacent spaces before this point,
***REMOVED*** because MERIDIEM_RE likes to eat up loading spaces
...
***REMOVED***
    function injectTzoStr(s, tzoStr) {
        ...
        s = s.replace(UTC_RE, function () {
            ...
            return tzoStr;
    ***REMOVED***);
***REMOVED*** IE11 doesn't include UTC/GMT in the original string, so append to end
        if (!replaced) {
            s += ' ' + tzoStr;
    ***REMOVED***
        return s;
***REMOVED***
    ...
    ***REMOVED***
            ...
            parts.push(weekLabel, ' ');
    ***REMOVED***
***REMOVED*** otherwise, considered 'numeric'
...
***REMOVED*** if hasEnd has not been specified, guess a good value based on deltas.
***REMOVED*** if duration will change, there's no way the default duration will persist,
***REMOVED*** and thus, we need to mark the event as having a real end
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***;
    ***REMOVED***
***REMOVED*** in case event was all-day but the supplied deltas were not
***REMOVED*** better util for this?
        if (eventDef.allDay) {
            copy.range = {
        ...
        ***REMOVED***;
    ***REMOVED***
***REMOVED*** handle invalid durations
...
***REMOVED*** help out EventApi from having user modify props
...
***REMOVED*** guard against success/failure callbacks being called more than once
***REMOVED*** and guard against a promise AND callback being used together.
...
***REMOVED***
    ...
    var Mixin = /** @class */ (function () {
        function Mixin() {
    ***REMOVED***
***REMOVED*** mix into a CLASS
        Mixin.mixInto = function (destClass) {
            this.mixIntoObj(destClass.prototype);
    ***REMOVED***;
***REMOVED*** mix into ANY object
...
***REMOVED***
    ...
    ***REMOVED***
***REMOVED*** Queries the els for coordinates and stores them.
***REMOVED*** Call this method before using and of the get* methods below.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Populates the left/right internal coordinate arrays
        ...
        ***REMOVED***
            ...
            this.rights = rights;
    ***REMOVED***;
***REMOVED*** Populates the top/bottom internal coordinate arrays
    ...
    ***REMOVED***;
***REMOVED*** Given a left offset (from document left), returns the index of the el that it horizontally intersects.
***REMOVED*** If no intersection is made, returns undefined.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Given a top offset (from document top), returns the index of the el that it vertically intersects.
***REMOVED*** If no intersection is made, returns undefined.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Gets the width of the element at the given index
        PositionCache.prototype.getWidth = function (leftIndex) {
            return this.rights[leftIndex] - this.lefts[leftIndex];
    ***REMOVED***;
***REMOVED*** Gets the height of the element at the given index
    ...
    */
    var ScrollComponent = /** @class */ (function (_super) {
        ...
        ***REMOVED***)) || this;
            ...
            return _this;
    ***REMOVED***
***REMOVED*** sets to natural height, unlocks overflow
...
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
        ...
        ***REMOVED***);
    ***REMOVED***;
***REMOVED*** Causes any 'auto' overflow values to resolves to 'scroll' or 'hidden'.
***REMOVED*** Useful for preserving scrollbar widths regardless of future resizes.
***REMOVED*** Can pass in scrollbarWidths for optimization.
...
***REMOVED***());
    ...
    ***REMOVED***;
***REMOVED*** after destroy is called, this component won't ever be used again
...
***REMOVED***
    ...
    ***REMOVED***
        DateComponent.prototype.destroy = function () {
            ...
            removeElement(this.el);
    ***REMOVED***;
***REMOVED*** TODO: WHAT ABOUT (sourceSeg && sourceSeg.component.doesDragMirror)
***REMOVED***
***REMOVED*** Event Drag-n-Drop Rendering (for both events and external elements)
***REMOVED*** ---------------------------------------------------------------------------------------------------------------
        /*
...
***REMOVED*** TODO: move to Calendar
    ...
    ***REMOVED***;
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Pointer Interaction Utils
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
...
***REMOVED***);
    ...
    ***REMOVED***
***REMOVED*** retrieve any outbound GET/POST data from the options
...
***REMOVED*** event ajax
        ...
        timeZone: 'local',
***REMOVED*** allDayDefault: undefined,
***REMOVED*** locale
        locales: [],
        locale: '',
***REMOVED*** dir: will get this from the default locale
***REMOVED*** buttonIcons: null,
***REMOVED*** allows setting a min-height to the event segment to prevent short events overlapping each other
        timeGridEventMinHeight: 0,
        themeSystem: 'standard',
***REMOVED*** eventResizableFromStart: false,
        dragRevertDuration: 500,
        dragScroll: true,
        allDayMaintainDuration: false,
***REMOVED*** selectable: false,
        unselectAuto: true,
***REMOVED*** selectMinDistance: 0,
        dropAccept: '*',
        eventOrder: 'start,-duration,allDay,title',
***REMOVED*** ^ if start tie, longer events go before shorter. final tie-breaker is title text
***REMOVED*** rerenderDelay: null,
        eventLimit: false,
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            this.compute();
    ***REMOVED***;
***REMOVED*** Computes the flattened options hash for the calendar and assigns to `this.options`.
***REMOVED*** Assumes this.overrides and this.dynamicOverrides have already been initialized.
...
***REMOVED*** Week Number
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** TODO: choke on timeZoneName: long
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Builds a structure with info about what the dates/ranges will be for the "prev" view.
    ...
    ***REMOVED***;
***REMOVED*** Builds a structure with info about what the dates/ranges will be for the "next" view.
    ...
    ***REMOVED***;
***REMOVED*** Builds a structure holding dates/ranges for rendering around the given date.
***REMOVED*** Optional direction param indicates whether the date is being incremented/decremented
***REMOVED*** from its previous value. decremented = -1, incremented = 1 (default).
    ...
    ***REMOVED*** or if the range is completely outside of the valid range.
        ...
        ***REMOVED***;
    ***REMOVED***;
***REMOVED*** Builds an object with optional start/end properties.
***REMOVED*** Indicates the minimum/maximum dates to display.
***REMOVED*** not responsible for trimming hidden days.
        DateProfileGenerator.prototype.buildValidRange = function () {
            return this.getRangeOption('validRange', this.calendar.getNow()) ||
                { start: null, end: null ***REMOVED***; // completely open-ended
    ***REMOVED***;
***REMOVED*** Builds a structure with info about the "current" range, the range that is
***REMOVED*** highlighted as being the current month for example.
***REMOVED*** See build() for a description of `direction`.
***REMOVED*** Guaranteed to have `range` and `unit` properties. `duration` is optional.
    ...
    ***REMOVED***;
***REMOVED*** Returns a new activeRange to have time values (un-ambiguate)
***REMOVED*** minTime or maxTime causes the range to expand.
        ...
        ***REMOVED***
            return { start: start, end: end ***REMOVED***;
    ***REMOVED***;
***REMOVED*** Builds the "current" range when it is specified as an explicit duration.
***REMOVED*** `unit` is the already-computed greatestDurationDenominator unit of duration.
    ...
    ***REMOVED*** if range is completely enveloped by hidden days, go past the hidden days
        ...
        ***REMOVED***
            return res;
    ***REMOVED***;
***REMOVED*** Builds the "current" range when a dayCount is specified.
        ...
        ***REMOVED*** while (runningCount < dayCount);
            return { start: start, end: end ***REMOVED***;
    ***REMOVED***;
***REMOVED*** Builds a normalized range object for the "visible" range,
***REMOVED*** which is a way to define the currentRange and activeRange at the same time.
        ...
        ***REMOVED***
            return visibleRange;
    ***REMOVED***;
***REMOVED*** Computes the range that will represent the element/cells for *rendering*,
***REMOVED*** but which may have voided days/times.
***REMOVED*** not responsible for trimming hidden days.
        DateProfileGenerator.prototype.buildRenderRange = function (currentRange, currentRangeUnit, isRangeAllDay) {
            return currentRange;
    ***REMOVED***;
***REMOVED*** Compute the duration value that should be added/substracted to the current date
***REMOVED*** when a prev/next operation happens.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Arguments after name will be forwarded to a hypothetical function value
***REMOVED*** WARNING: passed-in arguments will be given to generator functions as-is and can cause side-effects.
***REMOVED*** Always clone your objects if you fear mutation.
    ...
    ***REMOVED***;
        /* Hidden Days
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Initializes internal variables related to calculating hidden days-of-week
    ...
    ***REMOVED***;
***REMOVED*** Remove days from the beginning and end of the range that are computed as hidden.
***REMOVED*** If the whole range is trimmed off, returns null
        ...
        ***REMOVED***
            return null;
    ***REMOVED***;
***REMOVED*** Is the current day hidden?
***REMOVED*** `day` is a day-of-week index (0-6), or a Date (used for UTC)
    ...
    ***REMOVED***;
***REMOVED*** Incrementing the current day until it is no longer a hidden day, returning a copy.
***REMOVED*** DOES NOT CONSIDER validRange!
***REMOVED*** If the initial value of `date` is not a hidden day, don't do anything.
***REMOVED*** Pass `isExclusive` as `true` if you are dealing with an end date.
***REMOVED*** `inc` defaults to `1` (increment one day forward each time)
...
***REMOVED***
    ...
    ***REMOVED***
***REMOVED*** console.log(action.type, nextState)
        return nextState;
***REMOVED***
    ...
    function parseOpenDateSpan(raw, dateEnv) {
        ...
        if (allDay == null) {
            allDay = (startMeta && startMeta.isTimeUnspecified) &&
                (!endMeta || endMeta.isTimeUnspecified);
    ***REMOVED***
***REMOVED*** use this leftover object as the selection object
        leftovers.range = {
...
***REMOVED***
    ...
    function isSpanPropsEqual(span0, span1) {
        ...
        ***REMOVED***
    ***REMOVED***
***REMOVED*** are there any props that span0 has that span1 DOESN'T have?
***REMOVED*** both have range/allDay, so no need to special-case.
...
***REMOVED***(Component));
    ...
    function computeTitle(dateProfile, viewOptions) {
        var range;
***REMOVED*** for views that span a large unit of time, show the proper interval, ignoring stray days before and after
...
***REMOVED***;
    ...
    ***REMOVED*** public API
        ...
        ***REMOVED***,
            ...
            configurable: true
    ***REMOVED***);
***REMOVED*** Public API for rendering
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
...
***REMOVED*** View
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
***REMOVED*** Returns a boolean about whether the view is okay to instantiate at some point
    ...
    ***REMOVED***;
        ...
        ***REMOVED***);
    ***REMOVED***;
***REMOVED*** Forces navigation to a view for the given date.
***REMOVED*** `viewType` can be a specific view name or a generic one like "week" or "day".
***REMOVED*** needs to change
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Given a duration singular unit, like "week" or "day", finds a matching view spec.
***REMOVED*** Preference is given to views that have corresponding buttons.
...
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
    ...
    ***REMOVED***;
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** for external API
        Calendar.prototype.getDate = function () {
            return this.dateEnv.toDate(this.state.currentDate);
    ***REMOVED***;
***REMOVED*** Date Formatting Utils
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
        Calendar.prototype.formatDate = function (d, formatter) {
            var dateEnv = this.dateEnv;
            return dateEnv.format(dateEnv.createMarker(d), createFormatter(formatter));
    ***REMOVED***;
***REMOVED*** `settings` is for formatter AND isEndExclusive
...
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
    ...
    ***REMOVED***;
***REMOVED*** Date Selection / Event Selection / DayClick
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
***REMOVED*** this public method receives start/end dates in any format, with any timezone
***REMOVED*** NOTE: args were changed from v3
...
***REMOVED*** Date Utils
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
***REMOVED*** Returns a DateMarker for the current date, as defined by the client's computer or from the `now` option
    ...
    ***REMOVED***;
***REMOVED*** Event-Date Utilities
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
***REMOVED*** Given an event's allDay status and start date, return what its fallback end date should be.
***REMOVED*** TODO: rename to computeDefaultEventEnd
...
***REMOVED*** TODO: optimize
    ...
    ***REMOVED***;
***REMOVED*** Public Event Sources API
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
...
***REMOVED*** -----------------------------------------------------------------------------------------------------------------
    ...
    ***REMOVED***;
        ...
        /* Now Indicator
        ------------------------------------------------------------------------------------------------------------------*/
***REMOVED*** Immediately render the current time indicator and begins re-rendering it at an interval,
***REMOVED*** which is defined by this.getNowIndicatorUnit().
***REMOVED*** TODO: somehow do this for the current whole day's background too
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** rerenders the now indicator, computing the new current time from the amount of time that has passed
***REMOVED*** since the initial getNow call.
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Immediately unrenders the view's current time indicator and stops any re-rendering timers.
***REMOVED*** Won't cause side effects if indicator isn't rendered.
    ...
    ***REMOVED***;
***REMOVED*** Renders a current time indicator at the given datetime
        View.prototype.renderNowIndicator = function (date) {
    ***REMOVED*** SUBCLASSES MUST PASS TO CHILDREN!
    ***REMOVED***;
***REMOVED*** Undoes the rendering actions from renderNowIndicator
...
***REMOVED***(DateComponent));
    ...
    ***REMOVED***;
        FgEventRenderer.prototype.unrender = function (_segs, mirrorInfo) {
            ...
            this.segs = [];
    ***REMOVED***;
***REMOVED*** Updates values that rely on options and also relate to range
    ...
    ***REMOVED***;
***REMOVED*** Renders and assigns an `el` property for each foreground event segment.
***REMOVED*** Only returns segments that successfully rendered.
        ...
        ***REMOVED***
            return segs;
    ***REMOVED***;
***REMOVED*** Generic utility for generating the HTML classNames for an event segment's element
        ...
        ***REMOVED***
            return classes;
    ***REMOVED***;
***REMOVED*** Compute the text that should be displayed on an event's element.
***REMOVED*** `range` can be the Event object itself, or something range-like, with at least a `start`.
***REMOVED*** If event times are disabled, or the event has no time, will return a blank string.
***REMOVED*** If not specified, formatter will default to the eventTimeFormat setting,
***REMOVED*** and displayEnd will default to the displayEventEnd setting.
    ...
    ***REMOVED***;
        FgEventRenderer.prototype.computeDisplayEventEnd = function () {
            return true;
    ***REMOVED***;
***REMOVED*** Utility for generating event skin-related CSS properties
    ...
    ***REMOVED***;
***REMOVED*** Manipulation on rendered segs
...
***REMOVED***
    ...
    ***REMOVED***;
***REMOVED*** Unrenders a specific type of fill that is currently rendered on the grid
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Renders and assigns an `el` property for each fill segment. Generic enough to work with different types.
***REMOVED*** Only returns segments that successfully rendered.
        ...
        ***REMOVED***
            return segs;
    ***REMOVED***;
***REMOVED*** Builds the HTML needed for one fill segment. Generic enough to work with different types.
...
***REMOVED*** ensure required settings
...
***REMOVED*** if more than one week row, or if there are a lot of columns with not much space,
***REMOVED*** put just the day numbers will be in each cell
...
***REMOVED***
    ...
    ***REMOVED***
***REMOVED*** if only one row of days, the classNames on the header can represent the specific days beneath
...
***REMOVED***(Component));
    ...
    ***REMOVED*** deal with in-between indices
        ...
        ***REMOVED***
    ***REMOVED***;
***REMOVED*** Given a date, returns its chronolocial cell-index from the first cell of the grid.
***REMOVED*** If the date lies between cells (because of hiddenDays), returns a floating-point value between offsets.
***REMOVED*** If before the first offset, returns a negative number.
***REMOVED*** If after the last offset, returns an offset past the last cell offset.
***REMOVED*** Only works for *start* dates of cells. Will not work for exclusive end dates for cells.
